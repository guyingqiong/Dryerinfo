...
public class Calculate_11111_Dryer_Info {

	//take the input from outside
		public static double  Calculate_11111_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0096210507;
...
//				int G_MFG_BND_NMValue = 	G_MFG_BND_NM(G_MFG_BND_NM);	 
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0096210507;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// *** Compute Linear Predictor; 
					 ...
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    2.61866566577809) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.18127362212097) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.61751856814697) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.36109633917811) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.14734171115887) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.97856444140296) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (     0.7310592538418) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    0.53104686488683) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (    0.28282854870149) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (   -0.10265577833496) * _TEMP * _1_9; 
					 _LP0 = _LP0 + (   -0.68557602901781) * _TEMP * _1_10; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("4766_J"))  return   2; 
			 ...
			 else if (_Format.contains("6141_L"))  return   2; 
			 ...
			 else if (_Format.contains("7108_N"))  return   10; 
			 ...
			 else if (_Format.contains("7385_E"))  return   2; 
			 ...
			 else if (_Format.contains("7385_P"))  return   2; 
			 ...
			 else if (_Format.contains("7385_V"))  return   2; 
			 ...
			 else if (_Format.contains("7670_F"))  return   5; 
			 ...
			 else if (_Format.contains("7670_M"))  return   2; 
			 ...
			 else if (_Format.contains("7983_M"))  return   11; 
			 ...
			 else if (_Format.contains("8035_B"))  return   1; 
			 ...
			 else if (_Format.contains("8060_H"))  return   3; 
			 ...
			 else if (_Format.contains("8066AL"))  return   5; 
			 ...
			 else if (_Format.contains("8066PN"))  return   4; 
			 ...
			 else if (_Format.contains("8101_Z"))  return   7; 
			 ...
			 else if (_Format.contains("8129_Q"))  return   4; 
			 ...
			 else if (_Format.contains("8129_Y"))  return   11; 
			 ...
			 else if (_Format.contains("8150_P"))  return   11; 
			 ...
			 else if (_Format.contains("8158_O"))  return   4; 
			 ...
			 else if (_Format.contains("8180_G"))  return   6; 
			 ...
			 else if (_Format.contains("8180_K"))  return   2; 
			 ...
			 else if (_Format.contains("8206_C"))  return   5; 
			 ...
			 else if (_Format.contains("8206_V"))  return   2; 
			 ...
			 else if (_Format.contains("8254_L"))  return   2; 
			 ...
			 else if (_Format.contains("8368_A"))  return   9; 
			 else if (_Format.contains("8368_D"))  return   6; 
			 else if (_Format.contains("8368_G"))  return   5; 
			 else if (_Format.contains("8368_J"))  return   9; 
			 ...
			 else if (_Format.contains("9650_C"))  return   2; 
