...
public class Calculate_37220_Dryer_Info {

	//take the input from outside
		public static double  Calculate_37220_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0112462598;
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0112462598;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// ***  Effect: _14120 ;  
					 ...
					 _LP0 = _LP0 + (   -3.82056593012214 * _TEMP); 
					  
					 //***  Effect: _37130 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_37130")) ; 
					 _LP0 = _LP0 + (     9.5576053163317 * _TEMP); 
					  
	 		  
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    2.48411175557785) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    1.36047463351317) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    0.78428817263462) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    0.50673019201861) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (     0.3479448899448) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.00535632387882) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (   -0.31190265034919) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (   -0.69507252677488) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (   -1.14763132461749) * _TEMP * _1_8; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("4766_G"))  return   9; 
			 else if (_Format.contains("4766_I"))  return   7; 
			 else if (_Format.contains("4766_J"))  return   9; 
			 ...
			 else if (_Format.contains("6877_B"))  return   4; 
			 ...
			 else if (_Format.contains("7108_M"))  return   3; 
			 ...
			 else if (_Format.contains("7385_P"))  return   5; 
			 ...
			 else if (_Format.contains("7385_W"))  return   5; 
			 ...
			 else if (_Format.contains("7435_B"))  return   7; 
			 ...
			 else if (_Format.contains("7744_D"))  return   4; 
			 ...
			 else if (_Format.contains("7900N7"))  return   6; 
			 ...
			 else if (_Format.contains("7908M2"))  return   5; 
			 ...
			 else if (_Format.contains("8035_Z"))  return   5; 
			 else if (_Format.contains("8038_I"))  return   3; 
			 else if (_Format.contains("8038_K"))  return   5; 
			 else if (_Format.contains("8038_L"))  return   5; 
			 else if (_Format.contains("8038_M"))  return   7; 
			 else if (_Format.contains("8038_N"))  return   2; 
			 else if (_Format.contains("8038_O"))  return   1; 
			 else if (_Format.contains("8038_Q"))  return   7; 
			 else if (_Format.contains("8038_S"))  return   8; 
			 else if (_Format.contains("8038_U"))  return   4; 
			 else if (_Format.contains("8038_V"))  return   1; 
			 else if (_Format.contains("8060R1"))  return   1; 
			 ...
			 else if (_Format.contains("8060_E"))  return   1; 
			 ...
			 else if (_Format.contains("8060_O"))  return   1; 
			 else if (_Format.contains("8060_P"))  return   9; 
			 else if (_Format.contains("8060_Q"))  return   9; 
			 else if (_Format.contains("8060_S"))  return   4; 
			 else if (_Format.contains("8060_T"))  return   3; 
			 ...
			 else if (_Format.contains("8066MG"))  return   9; 
			 ...
			 else if (_Format.contains("8129_O"))  return   9; 
			 ...
			 else if (_Format.contains("8150_G"))  return   0; 
			 ...
			 else if (_Format.contains("8150_P"))  return   2; 
			 ...
			 else if (_Format.contains("8151_G"))  return   3; 
			 else if (_Format.contains("8151_K"))  return   9; 
			 ...
			 else if (_Format.contains("8162_F"))  return   6; 
			 ...
			 else if (_Format.contains("8227_D"))  return   9; 
			 else if (_Format.contains("8227_E"))  return   9; 
			 else if (_Format.contains("8227_F"))  return   9; 
			 else if (_Format.contains("8227_G"))  return   9; 
			 ...
			 else if (_Format.contains("8254_I"))  return   4; 
			 else if (_Format.contains("8254_J"))  return   2; 
			 ...
			 else if (_Format.contains("8320_H"))  return   5; 
			 ...
			 else if (_Format.contains("8935_D"))  return   7; 
			 ...
			 else if (_Format.contains("9700_A"))  return   5; 
			 ...
			 else if (_Format.contains("9702_V"))  return   1; 
			 else if (_Format.contains("9709_A"))  return   4; 
			 ...
			 else if (_Format.contains("9759_B"))  return   4; 
			 else if (_Format.contains("9759_N"))  return   5; 
			 else if (_Format.contains("9780_A"))  return   4; 
