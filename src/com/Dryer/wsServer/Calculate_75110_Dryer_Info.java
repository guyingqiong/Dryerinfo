...
public class Calculate_75110_Dryer_Info {

	//take the input from outside
		public static double  Calculate_75110_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0052354834;
				...
				int _DM_BAD  = 0;
				 ...
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 1 ) {
				       _2_0 = -1; 

					}
					else if (G_MFG_BND_NMValue == 0) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0052354834;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// ***  Effect: G_MDL_NO ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    1.21661435715378) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (   -0.57838654563909) * _TEMP * _1_1; 
					  
					  
					 //***  Effect: G_MFG_BND_NM ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    1.73512657341244) * _TEMP * _2_0; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("4766_L"))  return  3; 
			 ...
			 else if (_Format.contains("6141_G"))  return  2; 
			 ...
			 else if (_Format.contains("7084_B"))  return  8; 
			 ...
			 else if (_Format.contains("7194_A"))  return  8; 
			 ...
			 else if (_Format.contains("7194_G"))  return  11; 
			 else if (_Format.contains("7194_H"))  return  9; 
			 else if (_Format.contains("7194_L"))  return  7; 
			 else if (_Format.contains("7194_M"))  return  5; 
			 ...
			 else if (_Format.contains("7385_N"))  return  4; 
			 else if (_Format.contains("7385_O"))  return  0; 
			 else if (_Format.contains("7385_P"))  return  4; 
			 ...
			 else if (_Format.contains("7385_V"))  return  3; 
			 ...
			 else if (_Format.contains("7435_F"))  return  4; 
			 ...
			 else if (_Format.contains("7900C3"))  return  4; 
			 ...
			 else if (_Format.contains("7908M2"))  return  1; 
			 ...
			 else if (_Format.contains("8035_M"))  return  9; 
			 else if (_Format.contains("8035_O"))  return  7; 
			 ...
			 else if (_Format.contains("8035_V"))  return  1; 
			 ...
			 else if (_Format.contains("8038_N"))  return  4; 
			 ...
			 else if (_Format.contains("8060_D"))  return  3; 
			 else if (_Format.contains("8060_E"))  return  6; 
			 else if (_Format.contains("8060_F"))  return  2; 
			 ...
			 else if (_Format.contains("8060_M"))  return  1; 
			 else if (_Format.contains("8060_N"))  return  11; 
			 else if (_Format.contains("8060_O"))  return  0; 
			 else if (_Format.contains("8060_P"))  return  1; 
			 ...
			 else if (_Format.contains("8066JA"))  return  2; 
			 else if (_Format.contains("8066LA"))  return  7; 
			 ...
			 else if (_Format.contains("8101_X"))  return  0; 
			 else if (_Format.contains("8101_Y"))  return  7; 
			 ...
			 else if (_Format.contains("8150_B"))  return  2; 
			 ...
			 else if (_Format.contains("8150_Q"))  return  9; 
			 ...
			 else if (_Format.contains("8151_C"))  return  5; 
			 ...
			 else if (_Format.contains("8162_N"))  return  2; 
			 else if (_Format.contains("8162_Q"))  return  7; 
			 else if (_Format.contains("8162_R"))  return  1; 
			 else if (_Format.contains("8162_X"))  return  9; 
			 ...
			 else if (_Format.contains("8175_F"))  return  11; 
			 else if (_Format.contains("8175_G"))  return  10; 
			 else if (_Format.contains("8175_H"))  return  11; 
			 else if (_Format.contains("8175_I"))  return  0; 
			 else if (_Format.contains("8180_A"))  return  8; 
			 ...
			 else if (_Format.contains("8180_H"))  return  2; 
			 ...
			 else if (_Format.contains("8180_L"))  return  9; 
			 ...
			 else if (_Format.contains("8206_A"))  return  0; 
			 ...
			 else if (_Format.contains("8254_F"))  return  3; 
			 else if (_Format.contains("8254_G"))  return  2; 
			 ...
			 else if (_Format.contains("8254_M"))  return  9; 
			 ...
			 else if (_Format.contains("8368_A"))  return  11; 
			 ...
			 else if (_Format.contains("9702_S"))  return  8; 
			 ...
			 else if (_Format.contains("9780_A"))  return  6; 
		...
		public static int G_MFG_BND_NM(String _Format){
			...
			if (_Format.equalsIgnoreCase("ADMIRAL"))  return     1; 
			 if (_Format.equalsIgnoreCase("AMANA"))  return     1; 
			 if (_Format.equalsIgnoreCase("BOSCH"))  return     1; 
			 if (_Format.equalsIgnoreCase("CROSLEY"))  return     1; 
			 if (_Format.equalsIgnoreCase("ELECTROLUX"))  return     1; 
			 if (_Format.equalsIgnoreCase("ESTATE"))  return     1; 
			 if (_Format.equalsIgnoreCase("FISHERPAYKEL"))  return     1; 
			 if (_Format.equalsIgnoreCase("FRIGIDAIRE"))  return     1; 
			 if (_Format.equalsIgnoreCase("GALAXY"))  return     1; 
			 if (_Format.equalsIgnoreCase("GALLERY"))  return     0; 
			 if (_Format.equalsIgnoreCase("GE"))  return     0; 
			 if (_Format.equalsIgnoreCase("GE CAFE"))  return     1; 
			 if (_Format.equalsIgnoreCase("GE PROFILE"))  return     1; 
			 if (_Format.equalsIgnoreCase("GIBSON"))  return     1; 
			 if (_Format.equalsIgnoreCase("HAIER"))  return     1; 
			 if (_Format.equalsIgnoreCase("HOTPOINT"))  return     0; 
			 if (_Format.equalsIgnoreCase("INGLIS"))  return     1; 
			 if (_Format.equalsIgnoreCase("JENN-AIR"))  return     1; 
			 if (_Format.equalsIgnoreCase("KELVINATOR"))  return     1; 
			 if (_Format.equalsIgnoreCase("KENMORE"))  return     1; 
			 if (_Format.equalsIgnoreCase("KENMORE ELIT"))  return     1; 
			 if (_Format.equalsIgnoreCase("KIRKLAND"))  return     1; 
			 if (_Format.equalsIgnoreCase("KITCHENAID"))  return     1; 
			 if (_Format.equalsIgnoreCase("LG"))  return     1; 
			 if (_Format.equalsIgnoreCase("MAGIC CHEF"))  return     1; 
			 if (_Format.equalsIgnoreCase("MAYTAG"))  return     1; 
			 if (_Format.equalsIgnoreCase("MONTGMY WARD"))  return     1; 
			 if (_Format.equalsIgnoreCase("NORGE"))  return     1; 
			 if (_Format.equalsIgnoreCase("ROPER"))  return     1; 
			 if (_Format.equalsIgnoreCase("SAMSUNG"))  return     1; 
			 if (_Format.equalsIgnoreCase("SEARS"))  return     1; 
			 if (_Format.equalsIgnoreCase("WHIRLPOOL"))  return     1; 
			 if (_Format.equalsIgnoreCase("WHITE WESTIN"))  return     1; 
