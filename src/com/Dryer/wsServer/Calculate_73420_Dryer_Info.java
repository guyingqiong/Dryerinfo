...
public class Calculate_73420_Dryer_Info {

	//take the input from outside
		public static double  Calculate_73420_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.005790762;
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.005790762;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// *** Compute Linear Predictor; 
					 ...
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    2.94544204825031) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.16699628729171) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.75245637309305) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.42460813435274) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.24058748961101) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.91669875986239) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.66659779507938) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    0.38397898762416) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (   -0.18957225143675) * _TEMP * _1_8; 
					...
					// ***  Effect: G_MDL_NO ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    0.99294804124636) * _TEMP * _2_0; 
					 _LP0 = _LP0 + (   -0.12860884938761) * _TEMP * _2_1; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("4766_I"))  return     4; 
			 else if (_Format.contains("4766_J"))  return     9; 
			 else if (_Format.contains("4766_K"))  return     9; 
			 else if (_Format.contains("4766_L"))  return     1; 
			 ...
			 else if (_Format.contains("7194_L"))  return     1; 
			 ...
			 else if (_Format.contains("7385_G"))  return     2; 
			 else if (_Format.contains("7385_H"))  return     9; 
			 else if (_Format.contains("7385_I"))  return     3; 
			 ...
			 else if (_Format.contains("7670_T"))  return     3; 
			 ...
			 else if (_Format.contains("7900E3"))  return     1; 
			 ...
			 else if (_Format.contains("8035_E"))  return     9; 
			 ...
			 else if (_Format.contains("8035_U"))  return     5; 
			 else if (_Format.contains("8035_V"))  return     9; 
			 else if (_Format.contains("8035_W"))  return     9; 
			 else if (_Format.contains("8035_Y"))  return     2; 
			 ...
			 else if (_Format.contains("8066HO"))  return     1; 
			 ...
			 else if (_Format.contains("8129_E"))  return     2; 
			 ...
			 else if (_Format.contains("8175_E"))  return     9; 
			 ...
			 else if (_Format.contains("8180_D"))  return     1; 
			 ...
			 else if (_Format.contains("8206_H"))  return     4; 
			 ...
			 else if (_Format.contains("8227_I"))  return     4; 
			 ...
			 else if (_Format.contains("8254_K"))  return     1; 
			 else if (_Format.contains("8254_L"))  return     1; 
			 else if (_Format.contains("8254_M"))  return     9; 
			 else if (_Format.contains("8254_N"))  return     5; 
			 else if (_Format.contains("8254_O"))  return     4; 
			 ...
			 else if (_Format.contains("8368_D"))  return     4; 
			 else if (_Format.contains("8368_G"))  return     8; 
			 else if (_Format.contains("8368_J"))  return     7; 
			 else if (_Format.contains("8368_O"))  return     9; 
			 ...
			 else if (_Format.contains("8935_B"))  return     4; 
			 ...
			 else if (_Format.contains("8935_T"))  return     4; 
			 ...
			 else if (_Format.contains("9701_C"))  return     2; 
