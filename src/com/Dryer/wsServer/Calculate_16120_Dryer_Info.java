...
public class Calculate_16120_Dryer_Info {
  
	//take the input from outside
		public static double  Calculate_16120_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0132030417;
...
//				int G_ITM_AGE2Value =G_ITM_AGE2(G_ITM_AGE2);
				...
				int _DM_BAD  = 0;
				//*** Check _75110 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_75110")) -0.0 <=0.000000000000001  )  
	         				    _DM_BAD = 1; 
					...
					//	 *** Check _14240 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_14240")) -0.0 <=0.000000000000001  )  
	      				    _DM_BAD = 1; 
				 ...
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0132030417;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// ***  Effect: _75110 ;  
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_75110")) ; 
					 _LP0 = _LP0 + (    -23.188690314309 * _TEMP); 
					  
					 //***  Effect: _14320 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_14320")) ; 
					 _LP0 = _LP0 + (    -12.7305821897273 * _TEMP); 
					  
					// ***  Effect: _14240 ;  
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_14240")) ; 
					 _LP0 = _LP0 + (   23.907842189682 * _TEMP); 
					  
					  
					  
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    2.22771240769588) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.00672763672616) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.62093971119822) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.28311391324563) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (     1.2518783404192) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.89785459918888) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (     0.5742106975444) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    0.51125450063854) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (    0.31684329086248) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (    0.07985331903932) * _TEMP * _1_9; 
					 _LP0 = _LP0 + (   -0.44675882600333) * _TEMP * _1_10; 
					...
					// ***  Effect: G_MDL_NO ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    1.19391148088878) * _TEMP * _2_0; 
					 _LP0 = _LP0 + (    0.30578784196855) * _TEMP * _2_1; 
					 _LP0 = _LP0 + (   -0.16259838110113) * _TEMP * _2_2;  
					  
					 //***  Effect: G_MFG_BND_NM ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    1.60876052757012) * _TEMP * _3_0; 
					 _LP0 = _LP0 + (    1.23859652258678) * _TEMP * _3_1; 
					 _LP0 = _LP0 + (   -0.37158587997904) * _TEMP * _3_2; 
		...
		public static int G_IRU(String _Format){
			...
			if (_Format == null || _Format.isEmpty()) return 8; 
		
			//else if (_Format.contains("4766_A"))  return  6; 
			else if (_Format.contains("4766_A"))  return   2; 
			 else if (_Format.contains("4766_C"))  return   5; 
			 else if (_Format.contains("4766_E"))  return   10; 
			 else if (_Format.contains("4766_G"))  return   2; 
			 else if (_Format.contains("4766_I"))  return   1; 
			 else if (_Format.contains("4766_J"))  return   11; 
			 else if (_Format.contains("4766_K"))  return   11; 
			 else if (_Format.contains("4766_L"))  return   2; 
			 else if (_Format.contains("4766_S"))  return   11; 
			 else if (_Format.contains("4766_T"))  return   0; 
			 else if (_Format.contains("6141_A"))  return   11; 
			 else if (_Format.contains("6141_B"))  return   5; 
			 else if (_Format.contains("6141_C"))  return   8; 
			 else if (_Format.contains("6141_E"))  return   5; 
			 else if (_Format.contains("6141_F"))  return   11; 
			 else if (_Format.contains("6141_G"))  return   11; 
			 ...
			 else if (_Format.contains("6141_L"))  return   3; 
			 else if (_Format.contains("6877_B"))  return   10; 
			 else if (_Format.contains("6877_E"))  return   11; 
			 else if (_Format.contains("7084_A"))  return   11; 
			 else if (_Format.contains("7084_B"))  return   6; 
			 else if (_Format.contains("7084_C"))  return   5; 
			 ...
			 else if (_Format.contains("7108_N"))  return   5; 
			 else if (_Format.contains("7108_O"))  return   10; 
			 else if (_Format.contains("7108_S"))  return   9; 
			 else if (_Format.contains("7108_T"))  return   4; 
			 else if (_Format.contains("7108_X"))  return   7; 
			 else if (_Format.contains("7194_A"))  return   7; 
			 else if (_Format.contains("7194_C"))  return   4; 
			 else if (_Format.contains("7194_E"))  return   7; 
			 else if (_Format.contains("7194_F"))  return   5; 
			 else if (_Format.contains("7194_G"))  return   10; 
			 else if (_Format.contains("7194_H"))  return   8; 
			 ...
			 else if (_Format.contains("7194_P"))  return   8; 
			 else if (_Format.contains("7194_U"))  return   4; 
			 else if (_Format.contains("7289_A"))  return   6; 
			 else if (_Format.contains("7323_C"))  return   8; 
			 else if (_Format.contains("7323_E"))  return   3; 
			 ...
			 else if (_Format.contains("7385_G"))  return   11; 
			 else if (_Format.contains("7385_H"))  return   11; 
			 else if (_Format.contains("7385_I"))  return   11; 
			 else if (_Format.contains("7385_J"))  return   11; 
			 ...
			 else if (_Format.contains("7385_Q"))  return   11; 
			 ...
			 else if (_Format.contains("7435DD"))  return   10; 
			 else if (_Format.contains("7435EE"))  return   7; 
			 else if (_Format.contains("7435_A"))  return   11; 
			 else if (_Format.contains("7435_B"))  return   10; 
			 else if (_Format.contains("7435_C"))  return   9; 
			 else if (_Format.contains("7435_F"))  return   11; 
			 else if (_Format.contains("7670_B"))  return   8; 
			 else if (_Format.contains("7670_D"))  return   4; 
			 ...
			 else if (_Format.contains("7670_M"))  return   11; 
			 else if (_Format.contains("7670_P"))  return   7; 
			 else if (_Format.contains("7670_R"))  return   10; 
			 else if (_Format.contains("7670_S"))  return   1; 
			 else if (_Format.contains("7670_T"))  return   9; 
			 else if (_Format.contains("7670_V"))  return   7; 
			 else if (_Format.contains("7670_W"))  return   11; 
			 else if (_Format.contains("7670_X"))  return   11; 
			 else if (_Format.contains("7744_A"))  return   7; 
			 else if (_Format.contains("7744_B"))  return   11; 
			 ...
			 else if (_Format.contains("7744_K"))  return   11; 
			 else if (_Format.contains("7744_N"))  return   11; 
			 else if (_Format.contains("7744_S"))  return   8; 
			 else if (_Format.contains("7900C3"))  return   3; 
			 else if (_Format.contains("7900E3"))  return   3; 
			 else if (_Format.contains("7900E5"))  return   5; 
			 else if (_Format.contains("7900F6"))  return   7; 
			 else if (_Format.contains("7900G4"))  return   9; 
			 else if (_Format.contains("7900N3"))  return   11; 
			 else if (_Format.contains("7900N7"))  return   3; 
			 ...
			 else if (_Format.contains("7908F2"))  return   11; 
			 else if (_Format.contains("7908I5"))  return   11; 
			 else if (_Format.contains("7908L1"))  return   5; 
			 ...
			 else if (_Format.contains("7983_L"))  return   3; 
			 ...
			 else if (_Format.contains("7983_P"))  return   6; 
			 ...
			 else if (_Format.contains("8038_N"))  return   11; 
			 else if (_Format.contains("8038_O"))  return   11; 
			 else if (_Format.contains("8038_Q"))  return   7; 
			 else if (_Format.contains("8038_S"))  return   10; 
			 ...
			 else if (_Format.contains("8060_C"))  return   11; 
			 ...
			 else if (_Format.contains("8060_G"))  return   11; 
			 else if (_Format.contains("8060_H"))  return   4; 
			 else if (_Format.contains("8060_I"))  return   11; 
			 else if (_Format.contains("8060_J"))  return   11; 
			 else if (_Format.contains("8060_L"))  return   10; 
			 ...
			 else if (_Format.contains("8060_Q"))  return   1; 
			 else if (_Format.contains("8060_S"))  return   11; 
			 else if (_Format.contains("8060_T"))  return   6; 
			 else if (_Format.contains("8060_U"))  return   11; 
			 else if (_Format.contains("8060_V"))  return   11; 
			 ...
			 else if (_Format.contains("8066AL"))  return   11; 
			 else if (_Format.contains("8066BR"))  return   8; 
			 else if (_Format.contains("8066DO"))  return   4; 
			 ...
			 else if (_Format.contains("8101_K"))  return   6; 
			 else if (_Format.contains("8101_S"))  return   8; 
			 else if (_Format.contains("8101_T"))  return   6; 
			 else if (_Format.contains("8101_W"))  return   11; 
			 ...
			 else if (_Format.contains("8107_C"))  return   1; 
			 ...
			 else if (_Format.contains("8150_P"))  return   5; 
			 else if (_Format.contains("8150_Q"))  return   11; 
			 else if (_Format.contains("8150_R"))  return   11; 
			 else if (_Format.contains("8150_S"))  return   10; 
			 else if (_Format.contains("8150_T"))  return   11; 
			 else if (_Format.contains("8150_W"))  return   11; 
			 else if (_Format.contains("8151_B"))  return   11; 
			 else if (_Format.contains("8151_C"))  return   11; 
			 else if (_Format.contains("8151_E"))  return   10; 
			 else if (_Format.contains("8151_G"))  return   11; 
			 else if (_Format.contains("8151_K"))  return   11; 
			 else if (_Format.contains("8151_L"))  return   3; 
			 else if (_Format.contains("8151_N"))  return   9; 
			 ...
			 else if (_Format.contains("8162_B"))  return   11; 
			 else if (_Format.contains("8162_E"))  return   6; 
			 else if (_Format.contains("8162_F"))  return   11; 
			 ...
			 else if (_Format.contains("8162_M"))  return   1; 
			 ...
			 else if (_Format.contains("8162_Z"))  return   5; 
			 else if (_Format.contains("8175_A"))  return   5; 
			 ...
			 else if (_Format.contains("8180_B"))  return   11; 
			 else if (_Format.contains("8180_C"))  return   4; 
			 else if (_Format.contains("8180_D"))  return   7; 
			 else if (_Format.contains("8180_E"))  return   4; 
			 else if (_Format.contains("8180_F"))  return   6; 
			 else if (_Format.contains("8180_G"))  return   9; 
			 else if (_Format.contains("8180_H"))  return   4; 
			 else if (_Format.contains("8180_I"))  return   6; 
			 else if (_Format.contains("8180_J"))  return   0; 
			 else if (_Format.contains("8180_K"))  return   11; 
			 else if (_Format.contains("8180_L"))  return   7; 
			 else if (_Format.contains("8180_M"))  return   11; 
			 ...
			 else if (_Format.contains("8227_I"))  return   9; 
			 else if (_Format.contains("8245_A"))  return   11; 
			 else if (_Format.contains("8245_B"))  return   5; 
			 else if (_Format.contains("8245_C"))  return   6; 
			 else if (_Format.contains("8245_F"))  return   7; 
			 else if (_Format.contains("8245_L"))  return   11; 
			 else if (_Format.contains("8245_N"))  return   11; 
			 else if (_Format.contains("8245_W"))  return   5; 
			 else if (_Format.contains("8254_A"))  return   5; 
			 else if (_Format.contains("8254_B"))  return   4; 
			 ...
			 else if (_Format.contains("8254_F"))  return   5; 
			 else if (_Format.contains("8254_G"))  return   11; 
			 else if (_Format.contains("8254_H"))  return   0; 
			 else if (_Format.contains("8254_I"))  return   11; 
			 else if (_Format.contains("8254_J"))  return   8; 
			 else if (_Format.contains("8254_K"))  return   8; 
			 else if (_Format.contains("8254_L"))  return   8; 
			 else if (_Format.contains("8254_M"))  return   4; 
			 else if (_Format.contains("8254_N"))  return   8; 
			 else if (_Format.contains("8254_O"))  return   8; 
			 else if (_Format.contains("8254_P"))  return   4; 
			 else if (_Format.contains("8254_R"))  return   7; 
			 else if (_Format.contains("8320_G"))  return   5; 
			 else if (_Format.contains("8320_H"))  return   7; 
			 else if (_Format.contains("8320_I"))  return   6; 
			 else if (_Format.contains("8320_L"))  return   6; 
			 else if (_Format.contains("8320_M"))  return   7; 
			 else if (_Format.contains("8320_P"))  return   5; 
			 else if (_Format.contains("8320_X"))  return   11; 
			 else if (_Format.contains("8368_A"))  return   5; 
			 else if (_Format.contains("8368_D"))  return   10; 
			 ...
			 else if (_Format.contains("8368_R"))  return   2; 
			 else if (_Format.contains("8368_S"))  return   4; 
			 else if (_Format.contains("8368_X"))  return   6; 
			 else if (_Format.contains("8935_A"))  return   11; 
			 ...
			 else if (_Format.contains("8935_P"))  return   9; 
			 else if (_Format.contains("8935_S"))  return   8; 
			 else if (_Format.contains("8935_T"))  return   11; 
			 else if (_Format.contains("9197_A"))  return   7; 
			 else if (_Format.contains("9263_A"))  return   11; 
			 else if (_Format.contains("9265_A"))  return   11; 
			 else if (_Format.contains("9266_A"))  return   11; 
			 else if (_Format.contains("9650_A"))  return   10; 
			 else if (_Format.contains("9650_B"))  return   10; 
			 else if (_Format.contains("9650_C"))  return   11; 
			 ...
			 else if (_Format.contains("9700_D"))  return   8; 
			 ...
			 else if (_Format.contains("9702_S"))  return   3; 
			 else if (_Format.contains("9702_V"))  return   4; 
			 else if (_Format.contains("9709_A"))  return   8; 
			 else if (_Format.contains("9710_A"))  return   6; 
			 else if (_Format.contains("9712_A"))  return   6; 
			 else if (_Format.contains("9717_A"))  return   10; 
			 else if (_Format.contains("9720_A"))  return   7; 
			 else if (_Format.contains("9722_A"))  return   11; 
			 else if (_Format.contains("9727_A"))  return   5; 
			 else if (_Format.contains("9727_N"))  return   11; 
		...
		public static int G_MDL_NO(String _Format){
			...
			if (_Format == null || _Format.isEmpty()) return -1;
			    if (_Format.equalsIgnoreCase("1"))  return 3; 
			else if (_Format.equalsIgnoreCase("4")) return 0; 
			else if (_Format.equalsIgnoreCase("7")) return 3; 
		...
		public static int G_MFG_BND_NM(String _Format){
			if (_Format == null || _Format.isEmpty()) return 3; 
			 ...
			 else if (_Format.contains("BOSCH")) return   2; 
			 else if (_Format.contains("CROSLEY")) return   3; 
			 else if (_Format.contains("ELECTROLUX")) return   3; 
			 else if (_Format.contains("ESTATE")) return   3; 
			 else if (_Format.contains("FISHERPAYKEL")) return   0; 
			 else if (_Format.contains("FRIGIDAIRE")) return   1; 
			 else if (_Format.contains("GALAXY")) return   3; 
			 else if (_Format.contains("GALLERY")) return   0; 
			 else if (_Format.contains("GE")) return   0; 
			 else if (_Format.contains("GE CAFE")) return   3; 
			 else if (_Format.contains("GE PROFILE")) return   0; 
			 else if (_Format.contains("GIBSON")) return   0; 
			 else if (_Format.contains("HAIER")) return   3; 
			 else if (_Format.contains("HOTPOINT")) return   1; 
			 else if (_Format.contains("INGLIS")) return   1; 
			 else if (_Format.contains("JENN-AIR")) return   3; 
			 else if (_Format.contains("KELVINATOR")) return   0; 
			 else if (_Format.contains("KENMORE")) return   2; 
			 else if (_Format.contains("KENMORE ELIT")) return   2; 
			 else if (_Format.contains("KIRKLAND")) return   3; 
			 else if (_Format.contains("KITCHENAID")) return   3; 
			 else if (_Format.contains("LG")) return   3; 
			 else if (_Format.contains("MAGIC CHEF")) return   3; 
			 else if (_Format.contains("MAYTAG")) return   2; 
			 else if (_Format.contains("MONTGMY WARD")) return   3; 
			 else if (_Format.contains("NORGE")) return   1; 
			 else if (_Format.contains("ROPER")) return   3; 
			 else if (_Format.contains("SAMSUNG")) return   3; 
