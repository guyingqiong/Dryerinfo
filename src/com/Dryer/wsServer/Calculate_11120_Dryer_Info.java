...
public class Calculate_11120_Dryer_Info {

	//take the input from outside
	public static double  Calculate_11120_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
		try {
			
			MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
			//this value needs to be modified ..
			if(ProResults ==null) return  0.01802955441729;
			...
			/*		
			 //*** Generate dummy variables for G_MFG_BND_NM ; 
				...
				if (G_MFG_BND_NMValue == 0 ) {
				 ...
				 if (_DM_BAD > 0 ) return  0.01802955441729;
				    //_P0 = 0.1045190843; 
				    //_P1 = 0.8954809157; 
				...
				// ***  Effect: _11120 ;  
				 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_11120")) ; 
				 _LP0 = _LP0 + (    62.4842707878131 * _TEMP); 
				  
				 //***  Effect: _14120 ; 
				 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_14120")) ; 
				 _LP0 = _LP0 + (    39.9356265305682 * _TEMP); 
				  
				// ***  Effect: _16120 ;  
				 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_16120")) ; 
				 _LP0 = _LP0 + (   -29.3240046846567 * _TEMP); 
				  
				 //***  Effect: _31330 ; 
				 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_31330")) ; 
				 _LP0 = _LP0 + (    13.2543161648993 * _TEMP); 
				 
				// ***  Effect: _36120 ;  
				 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_36120")) ; 
				 _LP0 = _LP0 + (   -25.1867323180342 * _TEMP); 
				  
				 //***  Effect: _44444 ; 
				 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_44444")) ; 
				 _LP0 = _LP0 + (   -33.5653539597946 * _TEMP); 
				 
				// ***  Effect: _56320 ;  
				 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_56320")) ; 
				 _LP0 = _LP0 + (   -33.6924764166587 * _TEMP);
				  
				 //***  Effect: _88888 ; 
				 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_88888")) ; 
				 _LP0 = _LP0 + (    -31.800154643327 * _TEMP); 
				  
				 //***  Effect: G_IRU ; 
				 _TEMP = 1; 
				 _LP0 = _LP0 + (    1.50656038119819) * _TEMP * _1_0; 
				 _LP0 = _LP0 + (    1.24662633904942) * _TEMP * _1_1; 
				 _LP0 = _LP0 + (    0.96089929183273) * _TEMP * _1_2; 
				 _LP0 = _LP0 + (    0.72790962528575) * _TEMP * _1_3; 
				 _LP0 = _LP0 + (    0.62155341222204) * _TEMP * _1_4; 
				 _LP0 = _LP0 + (    0.40208375198791) * _TEMP * _1_5; 
				 _LP0 = _LP0 + (    0.28944751321985) * _TEMP * _1_6; 
				 _LP0 = _LP0 + (    0.06597892645476) * _TEMP * _1_7; 
				 _LP0 = _LP0 + (   -0.19700201894585) * _TEMP * _1_8; 
				 _LP0 = _LP0 + (   -0.49988812089937) * _TEMP * _1_9; 
				 _LP0 = _LP0 + (   -1.11957585245192) * _TEMP * _1_10; 
