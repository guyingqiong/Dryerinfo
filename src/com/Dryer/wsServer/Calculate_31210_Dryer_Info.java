...
public class Calculate_31210_Dryer_Info {

	//take the input from outside
		public static double  Calculate_31210_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String cvg_cd,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0137686415;
...
//				int G_MFG_BND_NMValue = 	G_MFG_BND_NM(G_MFG_BND_NM);	 
				...
				int _DM_BAD  = 0;
				//*** Check _11120 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_11120")) -0.0 <=0.000000000000001  )  
	         				    _DM_BAD = 1; 
					...
					//	 *** Check _16120 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_16120")) -0.0 <=0.000000000000001  )  
	      				    _DM_BAD = 1; 
						  
					//	 *** Check _31330 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_31330")) -0.0 <=0.000000000000001  )  
	      				    _DM_BAD = 1; 
	               ...
	               //	   *** Check _56320 for missing values ; 
					...
					//	 *** Check _88888 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_88888")) -0.0 <=0.000000000000001  )  
	      				    _DM_BAD = 1; 
						...
						// *** Generate dummy variables for G_IRU ; 
						 ...
						 if (IRUvalue == 3)  { 
							 ...
							 if (IRUvalue == 6 ) {
								 ...
								 //*** Generate dummy variables for cvg_cd ; 
								 int _2_0 =0;
								 if(cvg_cd.equalsIgnoreCase("SP")) _2_0=-1;
								 else if(cvg_cd.equalsIgnoreCase("IW")) _2_0=1;
								 else _DM_BAD = 1; 
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0137686415;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// *** Compute Linear Predictor; 
					 ...
					 //***  Effect: G_IRU ; 
					_TEMP = 1; 
					 _LP0 = _LP0 + (     2.5695383843759) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.28186405988819) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.66339564762698) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.29122005596659) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.10201864662451) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.82288216708469) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.58159536707114) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    0.35444647270131) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (    0.17664164397471) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (      0.025855539048) * _TEMP * _1_9; 
					 _LP0 = _LP0 + (   -0.20085991906087) * _TEMP * _1_10; 
					 _LP0 = _LP0 + (   -0.63113548510441) * _TEMP * _1_11; 
					  
					  
					// ***  Effect: G_ITM_AGE2 ; 
					 _TEMP = 1; 
                     _LP0 = _LP0 + (    0.39733530247679) * _TEMP * _3_0; 
                     _LP0 = _LP0 + (    0.15718326298503) * _TEMP * _3_1; 

                     //***  Effect: cvg_cd ; 
                     _TEMP = 1; 
                     _LP0 = _LP0 + (    0.55392148477436) * _TEMP * _2_0; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("4766_E"))  return   10; 
			 ...
			 else if (_Format.contains("4766_K"))  return   12; 
			 ...
			 else if (_Format.contains("6141_B"))  return   8; 
			 else if (_Format.contains("6141_C"))  return   4; 
			 else if (_Format.contains("6141_E"))  return   3; 
			 else if (_Format.contains("6141_F"))  return   12; 
			 else if (_Format.contains("6141_G"))  return   12; 
			 else if (_Format.contains("6141_H"))  return   6; 
			 else if (_Format.contains("6141_I"))  return   5; 
			 else if (_Format.contains("6141_J"))  return   10; 
			 else if (_Format.contains("6141_K"))  return   4; 
			 else if (_Format.contains("6141_L"))  return   9; 
			 else if (_Format.contains("6877_B"))  return   7; 
			 ...
			 else if (_Format.contains("7084_C"))  return   11; 
			 else if (_Format.contains("7084_D"))  return   11; 
			 else if (_Format.contains("7084_E"))  return   12; 
			 else if (_Format.contains("7084_F"))  return   11; 
			 else if (_Format.contains("7084_G"))  return   4; 
			 else if (_Format.contains("7084_H"))  return   12; 
			 else if (_Format.contains("7084_I"))  return   12; 
			 else if (_Format.contains("7084_J"))  return   12; 
			 else if (_Format.contains("7084_L"))  return   6; 
			 else if (_Format.contains("7108_M"))  return   11; 
			 else if (_Format.contains("7108_N"))  return   9; 
			 else if (_Format.contains("7108_O"))  return   9; 
			 else if (_Format.contains("7108_S"))  return   11; 
			 else if (_Format.contains("7108_T"))  return   7; 
			 else if (_Format.contains("7108_X"))  return   11; 
			 else if (_Format.contains("7194_A"))  return   12; 
			 ...
			 else if (_Format.contains("7194_G"))  return   12; 
			 else if (_Format.contains("7194_H"))  return   11; 
			 else if (_Format.contains("7194_L"))  return   7; 
			 else if (_Format.contains("7194_M"))  return   12; 
			 else if (_Format.contains("7194_N"))  return   8; 
			 else if (_Format.contains("7194_O"))  return   11; 
			 else if (_Format.contains("7194_P"))  return   9; 
			 else if (_Format.contains("7194_U"))  return   11; 
			 else if (_Format.contains("7289_A"))  return   7; 
			 ...
			 else if (_Format.contains("7385_G"))  return   12; 
			 ...
			 else if (_Format.contains("7385_L"))  return   5; 
			 else if (_Format.contains("7385_M"))  return   3; 
			 else if (_Format.contains("7385_N"))  return   9; 
			 else if (_Format.contains("7385_O"))  return   3; 
			 else if (_Format.contains("7385_P"))  return   8; 
			 else if (_Format.contains("7385_Q"))  return   12; 
			 else if (_Format.contains("7385_R"))  return   12; 
			 else if (_Format.contains("7385_S"))  return   7; 
			 else if (_Format.contains("7385_T"))  return   12; 
			 else if (_Format.contains("7385_V"))  return   12; 
			 else if (_Format.contains("7385_W"))  return   7; 
			 else if (_Format.contains("7385_Z"))  return   5; 
			 ...
			 else if (_Format.contains("7435_C"))  return   10; 
			 else if (_Format.contains("7435_F"))  return   12; 
			 else if (_Format.contains("7670_B"))  return   8; 
			 else if (_Format.contains("7670_D"))  return   10; 
			 else if (_Format.contains("7670_F"))  return   10; 
			 else if (_Format.contains("7670_G"))  return   9; 
			 else if (_Format.contains("7670_I"))  return   6; 
			 else if (_Format.contains("7670_K"))  return   10; 
			 else if (_Format.contains("7670_M"))  return   9; 
			 else if (_Format.contains("7670_P"))  return   12; 
			 else if (_Format.contains("7670_R"))  return   12; 
			 else if (_Format.contains("7670_S"))  return   5; 
			 else if (_Format.contains("7670_T"))  return   12; 
			 else if (_Format.contains("7670_V"))  return   5; 
			 ...
			 else if (_Format.contains("7744_B"))  return   9; 
			 else if (_Format.contains("7744_C"))  return   11; 
			 ...
			 else if (_Format.contains("7900N7"))  return   11; 
			 else if (_Format.contains("7900O1"))  return   12; 
			 else if (_Format.contains("7900R6"))  return   6; 
			 else if (_Format.contains("7900T4"))  return   4; 
			 else if (_Format.contains("7900U3"))  return   12; 
			 else if (_Format.contains("7908F2"))  return   12; 
			 ...
			 else if (_Format.contains("7983_J"))  return   10; 
			 ...
			 else if (_Format.contains("8035_E"))  return   8; 
			 ...
			 else if (_Format.contains("8035_M"))  return   8; 
			 else if (_Format.contains("8035_O"))  return   5; 
			 else if (_Format.contains("8035_P"))  return   5; 
			 else if (_Format.contains("8035_Q"))  return   12; 
			 else if (_Format.contains("8035_S"))  return   12; 
			 else if (_Format.contains("8035_T"))  return   12; 
			 else if (_Format.contains("8035_U"))  return   12; 
			 else if (_Format.contains("8035_V"))  return   2; 
			 else if (_Format.contains("8035_W"))  return   8; 
			 else if (_Format.contains("8035_Y"))  return   6; 
			 else if (_Format.contains("8035_Z"))  return   4; 
			 else if (_Format.contains("8038_I"))  return   6; 
			 else if (_Format.contains("8038_K"))  return   5; 
			 else if (_Format.contains("8038_L"))  return   11; 
			 else if (_Format.contains("8038_M"))  return   5; 
			 else if (_Format.contains("8038_N"))  return   12; 
			 ...
			 else if (_Format.contains("8060_C"))  return   12; 
			 else if (_Format.contains("8060_D"))  return   6; 
			 else if (_Format.contains("8060_E"))  return   12; 
			 ...
			 else if (_Format.contains("8060_I"))  return   12; 
			 ...
			 else if (_Format.contains("8060_P"))  return   2; 
			 else if (_Format.contains("8060_Q"))  return   12; 
			 ...
			 else if (_Format.contains("8060_V"))  return   7; 
			 else if (_Format.contains("8060_W"))  return   1; 
			 else if (_Format.contains("8060_X"))  return   12; 
			 else if (_Format.contains("8060_Z"))  return   4; 
			 else if (_Format.contains("8066AL"))  return   7; 
			 else if (_Format.contains("8066BR"))  return   9; 
			 else if (_Format.contains("8066DO"))  return   7; 
			 else if (_Format.contains("8066GP"))  return   7; 
			 else if (_Format.contains("8066HA"))  return   3; 
			 else if (_Format.contains("8066HO"))  return   5; 
			 else if (_Format.contains("8066JA"))  return   9; 
			 else if (_Format.contains("8066LA"))  return   4; 
			 else if (_Format.contains("8066MB"))  return   9; 
			 else if (_Format.contains("8066ME"))  return   5; 
			 else if (_Format.contains("8066MG"))  return   4; 
			 else if (_Format.contains("8066NO"))  return   11; 
			 else if (_Format.contains("8066PC"))  return   6; 
			 else if (_Format.contains("8066PN"))  return   12; 
			 ...
			 else if (_Format.contains("8107_E"))  return   2; 
			 else if (_Format.contains("8107_F"))  return   5; 
			 else if (_Format.contains("8107_L"))  return   7; 
			 else if (_Format.contains("8107_S"))  return   7; 
			 else if (_Format.contains("8129_A"))  return   9; 
			 else if (_Format.contains("8129_B"))  return   12; 
			 ...
			 else if (_Format.contains("8129_O"))  return   12; 
			 else if (_Format.contains("8129_P"))  return   11; 
			 else if (_Format.contains("8129_Q"))  return   12; 
			 else if (_Format.contains("8129_R"))  return   9; 
			 ...
			 else if (_Format.contains("8147_D"))  return   12; 
			 else if (_Format.contains("8147_E"))  return   6; 
			 else if (_Format.contains("8147_F"))  return   11; 
			 else if (_Format.contains("8147_G"))  return   2; 
			 else if (_Format.contains("8147_L"))  return   7; 
			 else if (_Format.contains("8147_O"))  return   5; 
			 else if (_Format.contains("8150F1"))  return   8; 
			 else if (_Format.contains("8150_A"))  return   12; 
			 else if (_Format.contains("8150_B"))  return   12; 
			 ...
			 else if (_Format.contains("8150_K"))  return   12; 
			 else if (_Format.contains("8150_L"))  return   5; 
			 else if (_Format.contains("8150_O"))  return   12; 
			 else if (_Format.contains("8150_P"))  return   7; 
			 else if (_Format.contains("8150_Q"))  return   12; 
			 else if (_Format.contains("8150_R"))  return   7; 
			 else if (_Format.contains("8150_S"))  return   8; 
			 else if (_Format.contains("8150_T"))  return   7; 
			 else if (_Format.contains("8150_W"))  return   12; 
			 else if (_Format.contains("8151_B"))  return   7; 
			 else if (_Format.contains("8151_C"))  return   12; 
			 else if (_Format.contains("8151_E"))  return   6; 
			 else if (_Format.contains("8151_G"))  return   2; 
			 ...
			 else if (_Format.contains("8158_D"))  return   12; 
			 else if (_Format.contains("8158_K"))  return   12; 
			 else if (_Format.contains("8158_L"))  return   12; 
			 else if (_Format.contains("8158_M"))  return   12; 
			 else if (_Format.contains("8158_O"))  return   9; 
			 else if (_Format.contains("8162_A"))  return   12; 
			 else if (_Format.contains("8162_B"))  return   9; 
			 else if (_Format.contains("8162_E"))  return   5; 
			 ...
			 else if (_Format.contains("8162_L"))  return   12; 
			 ...
			 else if (_Format.contains("8175_D"))  return   12; 
			 else if (_Format.contains("8175_E"))  return   12; 
			 else if (_Format.contains("8175_F"))  return   12; 
			 else if (_Format.contains("8175_G"))  return   11; 
			 ...
			 else if (_Format.contains("8206_C"))  return   3; 
			 ...
			 else if (_Format.contains("8206_I"))  return   2; 
			 else if (_Format.contains("8206_J"))  return   5; 
			 else if (_Format.contains("8206_K"))  return   2; 
			 else if (_Format.contains("8206_L"))  return   9; 
			 else if (_Format.contains("8206_M"))  return   8; 
			 ...
			 else if (_Format.contains("8227_A"))  return   9; 
			 else if (_Format.contains("8227_C"))  return   3; 
			 else if (_Format.contains("8227_D"))  return   4; 
			 else if (_Format.contains("8227_E"))  return   12; 
			 else if (_Format.contains("8227_F"))  return   12; 
			 else if (_Format.contains("8227_G"))  return   5; 
			 else if (_Format.contains("8227_H"))  return   12; 
			 ...
			 else if (_Format.contains("8254_B"))  return   11; 
			 else if (_Format.contains("8254_C"))  return   0; 
			 else if (_Format.contains("8254_D"))  return   2; 
			 else if (_Format.contains("8254_E"))  return   7; 
			 ...
			 else if (_Format.contains("8254_I"))  return   12; 
			 else if (_Format.contains("8254_J"))  return   12; 
			 else if (_Format.contains("8254_K"))  return   8; 
			 else if (_Format.contains("8254_L"))  return   6; 
			 else if (_Format.contains("8254_M"))  return   8; 
			 else if (_Format.contains("8254_N"))  return   6; 
			 else if (_Format.contains("8254_O"))  return   5; 
			 else if (_Format.contains("8254_P"))  return   1; 
			 else if (_Format.contains("8254_R"))  return   8; 
			 ...
			 else if (_Format.contains("8320_M"))  return   11; 
			 else if (_Format.contains("8320_P"))  return   11; 
			 else if (_Format.contains("8320_X"))  return   12; 
			 else if (_Format.contains("8368_A"))  return   12; 
			 ...
			 else if (_Format.contains("8368_R"))  return   10; 
		...
		public static int G_ITM_AGE2(String _Format){
			...
			else if (_Format.equalsIgnoreCase("20")) return 2; 
		...
		//Take the input to get the cvg_cd
				public static int cvg_cd(String _Format){
