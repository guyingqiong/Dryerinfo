...
public class Calculate_56320_Dryer_Info {

	//take the input from outside
		public static double  Calculate_56320_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0275124898;
				
				int IRUvalue =G_IRU(G_IRU);

				
				int _DM_BAD  = 0;
				//*** Check _14625 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_14625")) -0.0 <=0.000000000000001  )  
	         				    _DM_BAD = 1; 
	 
						  
					//	 *** Check _73270 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_73270")) -0.0 <=0.000000000000001  )  
	      				    _DM_BAD = 1; 
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0275124898;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// ***  Effect: _14625 ;  
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_14625")) ; 
					 _LP0 = _LP0 + (     27.801182199929 * _TEMP); 
					  
					 //***  Effect: _73270 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_73270")) ; 
					 _LP0 = _LP0 + (   -73.6232814936305 * _TEMP); 
					  
					 
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    2.75953388238778) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.06355944094637) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.37415617535787) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.06063129601344) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    0.82480690691831) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (     0.6968057949143) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.56117669276639) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    0.46148165953355) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (    0.31364592440582) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (    0.16034040070459) * _TEMP * _1_9; 
					 _LP0 = _LP0 + (   -0.16815738027277) * _TEMP * _1_10; 
					 _LP0 = _LP0 + (   -0.71465518816507) * _TEMP * _1_11; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			else if (_Format.contains("4766_A"))  return   5; 
			 ...
			 else if (_Format.contains("4766_K"))  return   2; 
			 else if (_Format.contains("4766_L"))  return   0; 
			 ...
			 else if (_Format.contains("6141_E"))  return   2; 
			 else if (_Format.contains("6141_F"))  return   7; 
			 else if (_Format.contains("6141_G"))  return   12; 
			 else if (_Format.contains("6141_H"))  return   8; 
			 else if (_Format.contains("6141_I"))  return   9; 
			 else if (_Format.contains("6141_J"))  return   9; 
			 else if (_Format.contains("6141_K"))  return   3; 
			 else if (_Format.contains("6141_L"))  return   11; 
			 else if (_Format.contains("6877_B"))  return   9; 
			 else if (_Format.contains("6877_E"))  return   4; 
			 else if (_Format.contains("7084_A"))  return   5; 
			 else if (_Format.contains("7084_B"))  return   5; 
			 else if (_Format.contains("7084_C"))  return   9; 
			 else if (_Format.contains("7084_D"))  return   9; 
			 else if (_Format.contains("7084_E"))  return   4; 
			 else if (_Format.contains("7084_F"))  return   6; 
			 else if (_Format.contains("7084_G"))  return   12; 
			 else if (_Format.contains("7084_H"))  return   9; 
			 else if (_Format.contains("7084_I"))  return   9; 
			 else if (_Format.contains("7084_J"))  return   9; 
			 else if (_Format.contains("7084_L"))  return   11; 
			 ...
			 else if (_Format.contains("7108_X"))  return   10; 
			 ...
			 else if (_Format.contains("7194_F"))  return   6; 
			 else if (_Format.contains("7194_G"))  return   9; 
			 ...
			 else if (_Format.contains("7194_O"))  return   6; 
			 else if (_Format.contains("7194_P"))  return   5; 
			 else if (_Format.contains("7194_U"))  return   10; 
			 else if (_Format.contains("7289_A"))  return   8; 
			 ...
			 else if (_Format.contains("7385_G"))  return   3; 
			 ...
			 else if (_Format.contains("7385_Q"))  return   9; 
			 else if (_Format.contains("7385_R"))  return   4; 
			 else if (_Format.contains("7385_S"))  return   10; 
			 else if (_Format.contains("7385_T"))  return   8; 
			 ...
			 else if (_Format.contains("7435EE"))  return   5; 
			 else if (_Format.contains("7435_A"))  return   10; 
			 else if (_Format.contains("7435_B"))  return   3; 
			 ...
			 else if (_Format.contains("7670_D"))  return   11; 
			 ...
			 else if (_Format.contains("7670_M"))  return   10; 
			 ...
			 else if (_Format.contains("7670_T"))  return   4; 
			 else if (_Format.contains("7670_V"))  return   4; 
			 else if (_Format.contains("7670_W"))  return   3; 
			 else if (_Format.contains("7670_X"))  return   2; 
			 ...
			 else if (_Format.contains("7744_D"))  return   11; 
			 else if (_Format.contains("7744_H"))  return   9; 
			 else if (_Format.contains("7744_J"))  return   10; 
			 else if (_Format.contains("7744_K"))  return   12; 
			 else if (_Format.contains("7744_N"))  return   4; 
			 else if (_Format.contains("7744_S"))  return   11; 
			 else if (_Format.contains("7900C3"))  return   5; 
			 ...
			 else if (_Format.contains("7908M2"))  return   8; 
			 else if (_Format.contains("7983_J"))  return   11; 
			 else if (_Format.contains("7983_K"))  return   6; 
			 else if (_Format.contains("7983_L"))  return   8; 
			 else if (_Format.contains("7983_M"))  return   9; 
			 else if (_Format.contains("7983_N"))  return   10; 
			 else if (_Format.contains("7983_O"))  return   8; 
			 else if (_Format.contains("7983_P"))  return   11; 
			 ...
			 else if (_Format.contains("8035_G"))  return   4; 
			 ...
			 else if (_Format.contains("8035_S"))  return   2; 
			 else if (_Format.contains("8035_T"))  return   9; 
			 else if (_Format.contains("8035_U"))  return   7; 
			 else if (_Format.contains("8035_V"))  return   7; 
			 else if (_Format.contains("8035_W"))  return   12; 
			 else if (_Format.contains("8035_Y"))  return   5; 
			 else if (_Format.contains("8035_Z"))  return   10; 
			 else if (_Format.contains("8038_I"))  return   9; 
			 else if (_Format.contains("8038_K"))  return   11; 
			 else if (_Format.contains("8038_L"))  return   10; 
			 else if (_Format.contains("8038_M"))  return   5; 
			 else if (_Format.contains("8038_N"))  return   10; 
			 else if (_Format.contains("8038_O"))  return   2; 
			 else if (_Format.contains("8038_Q"))  return   9; 
			 else if (_Format.contains("8038_S"))  return   8; 
			 else if (_Format.contains("8038_U"))  return   5; 
			 else if (_Format.contains("8038_V"))  return   5; 
			 ...
			 else if (_Format.contains("8060_S"))  return   2; 
			 else if (_Format.contains("8060_T"))  return   10; 
			 ...
			 else if (_Format.contains("8060_X"))  return   4; 
			 ...
			 else if (_Format.contains("8066DO"))  return   10; 
			 else if (_Format.contains("8066GP"))  return   10; 
			 else if (_Format.contains("8066HA"))  return   11; 
			 ...
			 else if (_Format.contains("8066NO"))  return   8; 
			 else if (_Format.contains("8066PC"))  return   8; 
			 ...
			 else if (_Format.contains("8078_A"))  return   9; 
			 else if (_Format.contains("8078_B"))  return   12; 
			 else if (_Format.contains("8078_C"))  return   8; 
			 else if (_Format.contains("8078_D"))  return   10; 
			 ...
			 else if (_Format.contains("8101_C"))  return   2; 
			 else if (_Format.contains("8101_K"))  return   7; 
			 else if (_Format.contains("8101_S"))  return   7; 
			 else if (_Format.contains("8101_T"))  return   3; 
			 else if (_Format.contains("8101_W"))  return   8; 
			 else if (_Format.contains("8101_X"))  return   1; 
			 else if (_Format.contains("8101_Y"))  return   5; 
			 ...
			 else if (_Format.contains("8107_E"))  return   7; 
			 else if (_Format.contains("8107_F"))  return   8; 
			 else if (_Format.contains("8107_L"))  return   9; 
			 else if (_Format.contains("8107_S"))  return   10; 
			 else if (_Format.contains("8129_A"))  return   7; 
			 ...
			 else if (_Format.contains("8150_P"))  return   6; 
			 ...
			 else if (_Format.contains("8158_O"))  return   11; 
			 else if (_Format.contains("8162_A"))  return   6; 
			 else if (_Format.contains("8162_B"))  return   5; 
			 else if (_Format.contains("8162_E"))  return   7; 
			 ...
			 else if (_Format.contains("8162_K"))  return   3; 
			 ...
			 else if (_Format.contains("8175_F"))  return   9; 
			 else if (_Format.contains("8175_G"))  return   9; 
			 else if (_Format.contains("8175_H"))  return   5; 
			 else if (_Format.contains("8175_I"))  return   12; 
			 else if (_Format.contains("8180_A"))  return   3; 
			 else if (_Format.contains("8180_B"))  return   6; 
			 else if (_Format.contains("8180_C"))  return   9; 
			 else if (_Format.contains("8180_D"))  return   4; 
			 else if (_Format.contains("8180_E"))  return   8; 
			 else if (_Format.contains("8180_F"))  return   7; 
			 else if (_Format.contains("8180_G"))  return   11; 
			 else if (_Format.contains("8180_H"))  return   9; 
			 ...
			 else if (_Format.contains("8206_D"))  return   4; 
			 ...
			 else if (_Format.contains("8206_J"))  return   2; 
			 ...
			 else if (_Format.contains("8206_P"))  return   9; 
			 else if (_Format.contains("8206_R"))  return   3; 
			 else if (_Format.contains("8206_S"))  return   12; 
			 else if (_Format.contains("8206_V"))  return   4; 
			 else if (_Format.contains("8227_A"))  return   9; 
			 else if (_Format.contains("8227_C"))  return   5; 
			 else if (_Format.contains("8227_D"))  return   2; 
			 ...
			 else if (_Format.contains("8254_C"))  return   12; 
			 ...
			 else if (_Format.contains("8254_G"))  return   9; 
			 else if (_Format.contains("8254_H"))  return   12; 
			 else if (_Format.contains("8254_I"))  return   2; 
			 else if (_Format.contains("8254_J"))  return   11; 
			 else if (_Format.contains("8254_K"))  return   6; 
			 else if (_Format.contains("8254_L"))  return   3; 
			 ...
			 else if (_Format.contains("8320_G"))  return   10; 
			 ...
			 else if (_Format.contains("8368_A"))  return   6; 
			 else if (_Format.contains("8368_D"))  return   9; 
			 else if (_Format.contains("8368_G"))  return   10; 
			 else if (_Format.contains("8368_J"))  return   10; 
			 else if (_Format.contains("8368_O"))  return   10; 
			 else if (_Format.contains("8368_P"))  return   8; 
			 else if (_Format.contains("8368_R"))  return   9; 
			 else if (_Format.contains("8368_S"))  return   6; 
			 else if (_Format.contains("8368_X"))  return   9; 
			 ...
			 else if (_Format.contains("9701_A"))  return   10; 
			 ...
			 else if (_Format.contains("9780_A"))  return   11; 
