...
public class Calculate_13140_Dryer_Info {

	//take the input from outside
		public static double  Calculate_13140_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.00956438964688;
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.00956438964688;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// *** Compute Linear Predictor; 
					 ...
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    2.48884250145313) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.05859881427665) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.79021585512872) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.60159382464781) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.31537359751193) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.90050476105937) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.51948704474793) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    0.14968312069607) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (   -0.39884885701064) * _TEMP * _1_8; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("4766_C"))  return  1; 
			 else if (_Format.contains("4766_E"))  return  1; 
			 ...
			 else if (_Format.contains("7194_M"))  return  2; 
			 ...
			 else if (_Format.contains("7385_T"))  return  5; 
			 ...
			 else if (_Format.contains("7435_C"))  return  2; 
			 ...
			 else if (_Format.contains("7900R6"))  return  5; 
			 ...
			 else if (_Format.contains("8066DO"))  return  3; 
			 ...
			 else if (_Format.contains("8078_C"))  return  5; 
			 else if (_Format.contains("8078_D"))  return  2; 
			 ...
			 else if (_Format.contains("8175_B"))  return  0; 
			 ...
			 else if (_Format.contains("8180_H"))  return  3; 
			 ...
			 else if (_Format.contains("8254_E"))  return  5; 
			 ...
			 else if (_Format.contains("9701_C"))  return  5; 
			 ...
			 else if (_Format.contains("9720_A"))  return  2; 
