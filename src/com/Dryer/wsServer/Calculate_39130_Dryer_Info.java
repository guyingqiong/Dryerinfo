...
public class Calculate_39130_Dryer_Info {

	//take the input from outside
	public static double  Calculate_39130_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
		try {
			
			MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
			//this value needs to be modified ..
			if(ProResults ==null) return  0.03229681338107;
		...
		//	 *** Check _32120 for missing values ; 
			 ...
			 //*** Generate dummy variables for G_MFG_BND_NM ; 
				...
				if (G_MFG_BND_NMValue == 0 ) {
				 ...
				 if (_DM_BAD > 0 ) return  0.0324597121;
				    //_P0 = 0.1045190843; 
				    //_P1 = 0.8954809157; 
				...
				// *** Compute Linear Predictor; 
				 ...
				 //***  Effect: G_IRU ; 
				 _TEMP = 1; 
				 _LP0 = _LP0 + (    28.4450605493477) * _TEMP * _1_0; 
				 _LP0 = _LP0 + (    0.39363058539886) * _TEMP * _1_1; 
				 _LP0 = _LP0 + (   -0.37916510578266) * _TEMP * _1_2; 
				 _LP0 = _LP0 + (   -0.90956739774191) * _TEMP * _1_3; 
				 _LP0 = _LP0 + (   -1.06545836610208) * _TEMP * _1_4; 
				 _LP0 = _LP0 + (    -1.2513967108009) * _TEMP * _1_5; 
				 _LP0 = _LP0 + (   -1.40738732734831) * _TEMP * _1_6; 
				 _LP0 = _LP0 + (   -1.54509956994504) * _TEMP * _1_7; 
				 _LP0 = _LP0 + (    -1.7447913888958) * _TEMP * _1_8; 
				 _LP0 = _LP0 + (   -1.96111467038776) * _TEMP * _1_9; 
				 _LP0 = _LP0 + (   -2.05988479029603) * _TEMP * _1_10; 
				 _LP0 = _LP0 + (   -2.29589499961037) * _TEMP * _1_11; 
				 _LP0 = _LP0 + (   -2.71809072083656) * _TEMP * _1_12; 
				...
				// ***  Effect: _35720 ; ProResults.Probility.get(ProResults.IDs.indexOf("_35720")
				 ...
				 _LP0 = _LP0 + (    9.29732483482112 * _TEMP); 
				  
				 //***  Effect: _32120 ; 
				 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_32120")) ; 
				 _LP0 = _LP0 + (   -9.09181973191515 * _TEMP); 
				  
				 
				 _TEMP =    -2.12448823482352 + _LP0; 
				 if (_TEMP < 0) {
	...
	public static int G_IRU(String _Format){
		...
		if (_Format == null || _Format.isEmpty()) return 10; 
	
		//else if (_Format.contains("4766_A"))  return  6; 
		else if (_Format.contains("4766_A")) return  13; 
		 ...
		 else if (_Format.contains("4766_L")) return  13; 
		 else if (_Format.contains("4766_S")) return  4; 
		 else if (_Format.contains("4766_T")) return  13; 
		 else if (_Format.contains("6141_A")) return  5; 
		 else if (_Format.contains("6141_B")) return  11; 
		 ...
		 else if (_Format.contains("6141_K")) return  12; 
		 else if (_Format.contains("6141_L")) return  9; 
		 else if (_Format.contains("6877_B")) return  9; 
		 else if (_Format.contains("6877_E")) return  10; 
		 ...
		 else if (_Format.contains("7084_H")) return  7; 
		 else if (_Format.contains("7084_I")) return  8; 
		 else if (_Format.contains("7084_J")) return  13; 
		 else if (_Format.contains("7084_L")) return  12; 
		 else if (_Format.contains("7108_M")) return  12; 
		 else if (_Format.contains("7108_N")) return  12; 
		 else if (_Format.contains("7108_O")) return  8; 
		 else if (_Format.contains("7108_S")) return  11; 
		 else if (_Format.contains("7108_T")) return  12; 
		 else if (_Format.contains("7108_X")) return  11; 
		 else if (_Format.contains("7194_A")) return  11; 
		 else if (_Format.contains("7194_C")) return  11; 
		 else if (_Format.contains("7194_E")) return  11; 
		 else if (_Format.contains("7194_F")) return  11; 
		 else if (_Format.contains("7194_G")) return  8; 
		 else if (_Format.contains("7194_H")) return  12; 
		 else if (_Format.contains("7194_L")) return  7; 
		 else if (_Format.contains("7194_M")) return  10; 
		 else if (_Format.contains("7194_N")) return  4; 
		 else if (_Format.contains("7194_O")) return  12; 
		 else if (_Format.contains("7194_P")) return  5; 
		 else if (_Format.contains("7194_U")) return  12; 
		 else if (_Format.contains("7289_A")) return  9; 
		 ...
		 else if (_Format.contains("7385_G")) return  13; 
		 else if (_Format.contains("7385_H")) return  11; 
		 else if (_Format.contains("7385_I")) return  8; 
		 else if (_Format.contains("7385_J")) return  4; 
		 else if (_Format.contains("7385_L")) return  7; 
		 else if (_Format.contains("7385_M")) return  13; 
		 ...
		 else if (_Format.contains("7385_R")) return  13; 
		 else if (_Format.contains("7385_S")) return  12; 
		 else if (_Format.contains("7385_T")) return  10; 
		 else if (_Format.contains("7385_V")) return  8; 
		 else if (_Format.contains("7385_W")) return  12; 
		 else if (_Format.contains("7385_Z")) return  5; 
		 else if (_Format.contains("7435DD")) return  9; 
		 else if (_Format.contains("7435EE")) return  12; 
		 else if (_Format.contains("7435_A")) return  12; 
		 else if (_Format.contains("7435_B")) return  12; 
		 else if (_Format.contains("7435_C")) return  9; 
		 else if (_Format.contains("7435_F")) return  9; 
		 else if (_Format.contains("7670_B")) return  10; 
		 else if (_Format.contains("7670_D")) return  9; 
		 else if (_Format.contains("7670_F")) return  7; 
		 else if (_Format.contains("7670_G")) return  10; 
		 ...
		 else if (_Format.contains("7670_V")) return  13; 
		 else if (_Format.contains("7670_W")) return  10; 
		 else if (_Format.contains("7670_X")) return  13; 
		 else if (_Format.contains("7744_A")) return  6; 
		 else if (_Format.contains("7744_B")) return  8; 
		 else if (_Format.contains("7744_C")) return  8; 
		 else if (_Format.contains("7744_D")) return  13; 
		 else if (_Format.contains("7744_H")) return  6; 
		 else if (_Format.contains("7744_J")) return  11; 
		 else if (_Format.contains("7744_K")) return  8; 
		 else if (_Format.contains("7744_N")) return  13; 
		 else if (_Format.contains("7744_S")) return  11; 
		 else if (_Format.contains("7900C3")) return  12; 
		 else if (_Format.contains("7900E3")) return  10; 
		 else if (_Format.contains("7900E5")) return  11; 
		 else if (_Format.contains("7900F6")) return  7; 
		 else if (_Format.contains("7900G4")) return  8; 
		 else if (_Format.contains("7900N3")) return  7; 
		 else if (_Format.contains("7900N7")) return  12; 
		 else if (_Format.contains("7900O1")) return  9; 
		 else if (_Format.contains("7900R6")) return  7; 
		 else if (_Format.contains("7900T4")) return  12; 
		 else if (_Format.contains("7900U3")) return  3; 
		 else if (_Format.contains("7908F2")) return  3; 
		 else if (_Format.contains("7908I5")) return  13; 
		 else if (_Format.contains("7908L1")) return  12; 
		 ...
		 else if (_Format.contains("7983_L")) return  11; 
		 else if (_Format.contains("7983_M")) return  10; 
		 else if (_Format.contains("7983_N")) return  11; 
		 else if (_Format.contains("7983_O")) return  9; 
		 else if (_Format.contains("7983_P")) return  9; 
		 else if (_Format.contains("8035_A")) return  5; 
		 else if (_Format.contains("8035_B")) return  4; 
		 else if (_Format.contains("8035_C")) return  13; 
		 else if (_Format.contains("8035_E")) return  13; 
		 ...
		 else if (_Format.contains("8035_J")) return  12; 
		 else if (_Format.contains("8035_M")) return  12; 
		 else if (_Format.contains("8035_O")) return  9; 
		 ...
		 else if (_Format.contains("8035_T")) return  11; 
		 else if (_Format.contains("8035_U")) return  4; 
		 else if (_Format.contains("8035_V")) return  13; 
		 else if (_Format.contains("8035_W")) return  7; 
		 else if (_Format.contains("8035_Y")) return  7; 
		 else if (_Format.contains("8035_Z")) return  8; 
		 ...
		 else if (_Format.contains("8038_O")) return  2; 
		 else if (_Format.contains("8038_Q")) return  8; 
		 else if (_Format.contains("8038_S")) return  7; 
		 else if (_Format.contains("8038_U")) return  13; 
		 else if (_Format.contains("8038_V")) return  11; 
		 else if (_Format.contains("8060R1")) return  13; 
		 else if (_Format.contains("8060_A")) return  5; 
		 else if (_Format.contains("8060_B")) return  10; 
		 else if (_Format.contains("8060_C")) return  3; 
		 ...
		 else if (_Format.contains("8060_H")) return  7; 
		 ...
		 else if (_Format.contains("8060_M")) return  4; 
		 else if (_Format.contains("8060_N")) return  13; 
		 else if (_Format.contains("8060_O")) return  13; 
		 else if (_Format.contains("8060_P")) return  13; 
		 else if (_Format.contains("8060_Q")) return  7; 
		 ...
		 else if (_Format.contains("8060_V")) return  8; 
		 else if (_Format.contains("8060_W")) return  3; 
		 else if (_Format.contains("8060_X")) return  7; 
		 else if (_Format.contains("8060_Z")) return  13; 
		 else if (_Format.contains("8066AL")) return  8; 
		 else if (_Format.contains("8066BR")) return  7; 
		 else if (_Format.contains("8066DO")) return  5; 
		 else if (_Format.contains("8066GP")) return  4; 
		 else if (_Format.contains("8066HA")) return  3; 
		 else if (_Format.contains("8066HO")) return  9; 
		 else if (_Format.contains("8066JA")) return  7; 
		 else if (_Format.contains("8066LA")) return  12; 
		 else if (_Format.contains("8066MB")) return  11; 
		 else if (_Format.contains("8066ME")) return  4; 
		 else if (_Format.contains("8066MG")) return  13; 
		 else if (_Format.contains("8066NO")) return  10; 
		 else if (_Format.contains("8066PC")) return  12; 
		 ...
		 else if (_Format.contains("8101_W")) return  7; 
		 else if (_Format.contains("8101_X")) return  13; 
		 else if (_Format.contains("8101_Y")) return  13; 
		 else if (_Format.contains("8101_Z")) return  11; 
		 else if (_Format.contains("8107_A")) return  7; 
		 else if (_Format.contains("8107_C")) return  5; 
		 else if (_Format.contains("8107_D")) return  7; 
		 else if (_Format.contains("8107_E")) return  13; 
		 else if (_Format.contains("8107_F")) return  10; 
		 else if (_Format.contains("8107_L")) return  12; 
		 else if (_Format.contains("8107_S")) return  8; 
		 else if (_Format.contains("8129_A")) return  12; 
		 else if (_Format.contains("8129_B")) return  12; 
		 else if (_Format.contains("8129_C")) return  13; 
		 else if (_Format.contains("8129_E")) return  9; 
		 else if (_Format.contains("8129_F")) return  9; 
		 else if (_Format.contains("8129_G")) return  11; 
		 else if (_Format.contains("8129_O")) return  11; 
		 else if (_Format.contains("8129_P")) return  5; 
		 else if (_Format.contains("8129_Q")) return  10; 
		 else if (_Format.contains("8129_R")) return  9; 
		 else if (_Format.contains("8129_S")) return  11; 
		 else if (_Format.contains("8129_U")) return  13; 
		 else if (_Format.contains("8129_V")) return  12; 
		 else if (_Format.contains("8129_W")) return  11; 
		 else if (_Format.contains("8129_X")) return  11; 
		 else if (_Format.contains("8129_Y")) return  7; 
		 else if (_Format.contains("8129_Z")) return  9; 
		 else if (_Format.contains("8147_A")) return  12; 
		 ...
		 else if (_Format.contains("8147_G")) return  5; 
		 ...
		 else if (_Format.contains("8150_A")) return  11; 
		 else if (_Format.contains("8150_B")) return  4; 
		 else if (_Format.contains("8150_C")) return  13; 
		 else if (_Format.contains("8150_E")) return  12; 
		 else if (_Format.contains("8150_G")) return  13; 
		 else if (_Format.contains("8150_I")) return  10; 
		 else if (_Format.contains("8150_K")) return  4; 
		 else if (_Format.contains("8150_L")) return  12; 
		 ...
		 else if (_Format.contains("8150_R")) return  6; 
		 else if (_Format.contains("8150_S")) return  8; 
		 else if (_Format.contains("8150_T")) return  6; 
		 else if (_Format.contains("8150_W")) return  13; 
		 ...
		 else if (_Format.contains("8151_K")) return  3; 
		 else if (_Format.contains("8151_L")) return  5; 
		 else if (_Format.contains("8151_N")) return  8; 
		 else if (_Format.contains("8158_C")) return  8; 
		 else if (_Format.contains("8158_D")) return  3; 
		 else if (_Format.contains("8158_K")) return  4; 
		 else if (_Format.contains("8158_L")) return  0; 
		 else if (_Format.contains("8158_M")) return  7; 
		 else if (_Format.contains("8158_O")) return  6; 
		 else if (_Format.contains("8162_A")) return  7; 
		 else if (_Format.contains("8162_B")) return  4; 
		 else if (_Format.contains("8162_E")) return  13; 
		 else if (_Format.contains("8162_F")) return  5; 
		 else if (_Format.contains("8162_H")) return  10; 
		 else if (_Format.contains("8162_I")) return  10; 
		 else if (_Format.contains("8162_K")) return  11; 
		 else if (_Format.contains("8162_L")) return  11; 
		 ...
		 else if (_Format.contains("8175_B")) return  3; 
		 else if (_Format.contains("8175_D")) return  4; 
		 else if (_Format.contains("8175_E")) return  13; 
		 else if (_Format.contains("8175_F")) return  8; 
		 else if (_Format.contains("8175_G")) return  10; 
		 else if (_Format.contains("8175_H")) return  7; 
		 else if (_Format.contains("8175_I")) return  13; 
		 else if (_Format.contains("8180_A")) return  13; 
		 else if (_Format.contains("8180_B")) return  8; 
		 else if (_Format.contains("8180_C")) return  13; 
		 else if (_Format.contains("8180_D")) return  8; 
		 ...
		 else if (_Format.contains("8180_I")) return  13; 
		 else if (_Format.contains("8180_J")) return  8; 
		 else if (_Format.contains("8180_K")) return  5; 
		 else if (_Format.contains("8180_L")) return  11; 
		 ...
		 else if (_Format.contains("8206_K")) return  11; 
		 else if (_Format.contains("8206_L")) return  8; 
		 else if (_Format.contains("8206_M")) return  10; 
		 else if (_Format.contains("8206_N")) return  13; 
		 else if (_Format.contains("8206_O")) return  3; 
		 else if (_Format.contains("8206_P")) return  6; 
		 else if (_Format.contains("8206_R")) return  8; 
		 else if (_Format.contains("8206_S")) return  12; 
		 else if (_Format.contains("8206_V")) return  13; 
		 else if (_Format.contains("8227_A")) return  8; 
		 else if (_Format.contains("8227_C")) return  13; 
		 else if (_Format.contains("8227_D")) return  8; 
		 else if (_Format.contains("8227_E")) return  8; 
		 else if (_Format.contains("8227_F")) return  3; 
		 else if (_Format.contains("8227_G")) return  11; 
		 else if (_Format.contains("8227_H")) return  12; 
		 else if (_Format.contains("8227_I")) return  11; 
		 else if (_Format.contains("8245_A")) return  12; 
		 else if (_Format.contains("8245_B")) return  10; 
		 else if (_Format.contains("8245_C")) return  8; 
		 else if (_Format.contains("8245_F")) return  11; 
		 else if (_Format.contains("8245_L")) return  10; 
		 else if (_Format.contains("8245_N")) return  8; 
		 else if (_Format.contains("8245_W")) return  12; 
		 else if (_Format.contains("8254_A")) return  10; 
		 else if (_Format.contains("8254_B")) return  8; 
		 else if (_Format.contains("8254_C")) return  13; 
		 else if (_Format.contains("8254_D")) return  9; 
		 else if (_Format.contains("8254_E")) return  9; 
		 else if (_Format.contains("8254_F")) return  7; 
		 else if (_Format.contains("8254_G")) return  13; 
		 else if (_Format.contains("8254_H")) return  7; 
		 else if (_Format.contains("8254_I")) return  11; 
		 else if (_Format.contains("8254_J")) return  5; 
		 else if (_Format.contains("8254_K")) return  11; 
		 else if (_Format.contains("8254_L")) return  11; 
		 else if (_Format.contains("8254_M")) return  10; 
		 else if (_Format.contains("8254_N")) return  11; 
		 else if (_Format.contains("8254_O")) return  9; 
		 else if (_Format.contains("8254_P")) return  11; 
		 else if (_Format.contains("8254_R")) return  3; 
		 else if (_Format.contains("8320_G")) return  11; 
		 else if (_Format.contains("8320_H")) return  11; 
		 else if (_Format.contains("8320_I")) return  12; 
		 else if (_Format.contains("8320_L")) return  9; 
		 else if (_Format.contains("8320_M")) return  11; 
		 else if (_Format.contains("8320_P")) return  12; 
		 else if (_Format.contains("8320_X")) return  3; 
		 ...
		 else if (_Format.contains("8368_P")) return  10; 
		 else if (_Format.contains("8368_R")) return  8; 
		 else if (_Format.contains("8368_S")) return  11; 
		 else if (_Format.contains("8368_X")) return  11; 
		 else if (_Format.contains("8935_A")) return  12; 
		 ...
		 else if (_Format.contains("8935_M")) return  4; 
		 else if (_Format.contains("8935_P")) return  10; 
		 else if (_Format.contains("8935_S")) return  10; 
		 else if (_Format.contains("8935_T")) return  5; 
		 else if (_Format.contains("9197_A")) return  11; 
		 ...
		 else if (_Format.contains("9650_A")) return  10; 
		 else if (_Format.contains("9650_B")) return  8; 
		 else if (_Format.contains("9650_C")) return  13; 
		 else if (_Format.contains("9663_A")) return  10; 
		 else if (_Format.contains("9664_A")) return  11; 
		 else if (_Format.contains("9665_A")) return  10; 
		 else if (_Format.contains("9700_A")) return  11; 
		 else if (_Format.contains("9700_D")) return  11; 
		 else if (_Format.contains("9701_A")) return  9; 
		 else if (_Format.contains("9701_B")) return  12; 
		 else if (_Format.contains("9701_C")) return  11; 
		 else if (_Format.contains("9702_A")) return  11; 
		 else if (_Format.contains("9702_S")) return  5; 
		 else if (_Format.contains("9702_V")) return  8; 
		 else if (_Format.contains("9709_A")) return  12; 
		 else if (_Format.contains("9710_A")) return  11; 
		 else if (_Format.contains("9712_A")) return  11; 
		 else if (_Format.contains("9717_A")) return  8; 
		 else if (_Format.contains("9720_A")) return  10; 
		 else if (_Format.contains("9722_A")) return  8; 
		 else if (_Format.contains("9727_A")) return  8; 
		 ...
		 else if (_Format.contains("9759_A")) return  11; 
		 else if (_Format.contains("9759_B")) return  9; 
		 else if (_Format.contains("9759_N")) return  11; 
		 else if (_Format.contains("9780_A")) return  9; 
		 else if (_Format.contains("9780_M")) return  10; 
		 else if (_Format.contains("9784_A")) return  10; 
