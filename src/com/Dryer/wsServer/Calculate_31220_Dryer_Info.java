...
public class Calculate_31220_Dryer_Info {

	//take the input from outside
		public static double  Calculate_31220_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String cvg_cd,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0127827388;
				
				int IRUvalue =G_IRU(G_IRU);
				int _DM_BAD  = 0;
				
				int _1_0 =0;
				if(cvg_cd == null || cvg_cd.isEmpty()) _DM_BAD = 1; 
				else if (cvg_cd.equalsIgnoreCase("SP")) _1_0=-1;
				else if (cvg_cd.equalsIgnoreCase("IW")) _1_0= 1;
				else _DM_BAD = 1;
						 
						 
						// *** Generate dummy variables for G_IRU ; 
						 double _2_0 =0.0 ,_2_1  =0.0,_2_2 =0.0, _2_3 =0.0 ,_2_4 =0.0, _2_5  =0.0,_2_6 =0.0 ,_2_7  =0.0,_2_8 =0.0, _2_9 =0.0   ;
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0127827388;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// *** Compute Linear Predictor; 
					 ...
					 //***  Effect: cvg_cd ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    0.77623154530277) * _TEMP * _1_0; 
					  
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    1.54258165436854) * _TEMP * _2_0; 
					 _LP0 = _LP0 + (    1.17264829838644) * _TEMP * _2_1; 
					 _LP0 = _LP0 + (    0.87036611987936) * _TEMP * _2_2; 
					 _LP0 = _LP0 + (    0.69264179617437) * _TEMP * _2_3; 
					 _LP0 = _LP0 + (    0.48361769513741) * _TEMP * _2_4; 
					 _LP0 = _LP0 + (    0.31539433504719) * _TEMP * _2_5; 
					 _LP0 = _LP0 + (    0.12692437551346) * _TEMP * _2_6; 
					 _LP0 = _LP0 + (   -0.16299235821841) * _TEMP * _2_7; 
					 _LP0 = _LP0 + (     -0.493718851344) * _TEMP * _2_8; 
					 _LP0 = _LP0 + (   -0.94349912201814) * _TEMP * _2_9; 

			 
			 
					  
					 
					 _TEMP =    -3.79910733034584 + _LP0; 
					 if (_TEMP < 0) {
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("7194_F"))  return    4; 
			 ...
			 else if (_Format.contains("7385_P"))  return    1; 
			 ...
			 else if (_Format.contains("7900O1"))  return    2; 
			 ...
			 else if (_Format.contains("8035_O"))  return    0; 
			 else if (_Format.contains("8035_P"))  return    1; 
			 else if (_Format.contains("8035_Q"))  return    7; 
			 else if (_Format.contains("8035_S"))  return    3; 
			 ...
			 else if (_Format.contains("8060_D"))  return    10; 
			 ...
			 else if (_Format.contains("8060_S"))  return    1; 
			 ...
			 else if (_Format.contains("8066HA"))  return    1; 
			 ...
			 else if (_Format.contains("8101_S"))  return    1; 
			 ...
			 else if (_Format.contains("8107_F"))  return    1; 
			 ...
			 else if (_Format.contains("8129_Z"))  return    2; 
			 else if (_Format.contains("8147_A"))  return    3; 
			 ...
			 else if (_Format.contains("8147_O"))  return    10; 
			 else if (_Format.contains("8150F1"))  return    5; 
			 else if (_Format.contains("8150_A"))  return    1; 
			 ...
			 else if (_Format.contains("8162_F"))  return    0; 
			 ...
			 else if (_Format.contains("8175_B"))  return    10; 
			 ...
			 else if (_Format.contains("8180_M"))  return    1; 
			 ...
			 else if (_Format.contains("8206_J"))  return    1; 
			 ...
			 else if (_Format.contains("8227_C"))  return    10; 
			 ...
			 else if (_Format.contains("8245_N"))  return    5; 
			 ...
			 else if (_Format.contains("8254_I"))  return    0; 
			 ...
			 else if (_Format.contains("8254_N"))  return    7; 
			 ...
			 else if (_Format.contains("8935_D"))  return    1; 
			 ...
			 else if (_Format.contains("8935_S"))  return    0; 
			 ...
			 else if (_Format.contains("9787_A"))  return    4; 
