...
public class Calculate_36410_Dryer_Info {
	
	//take the input from outside
		public static double  Calculate_36410_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
...
//				int G_ITM_AGE2Value =G_ITM_AGE2(G_ITM_AGE2);
		...
		public static int G_MFG_BND_NM(String _Format){
			if (_Format == null || _Format.isEmpty()) return 3; 
			 ...
			 else if (_Format.contains("AMANA")) return  2; 
			 else if (_Format.contains("BOSCH")) return  3; 
			 ...
			 else if (_Format.contains("FISHERPAYKEL")) return  2; 
			 else if (_Format.contains("FRIGIDAIRE")) return  2; 
			 else if (_Format.contains("GALAXY")) return  3; 
			 else if (_Format.contains("GALLERY")) return  3; 
			 else if (_Format.contains("GE")) return  0; 
			 else if (_Format.contains("GE CAFE")) return  3; 
			 else if (_Format.contains("GE PROFILE")) return  2; 
			 else if (_Format.contains("GIBSON")) return  3; 
			 else if (_Format.contains("HAIER")) return  3; 
			 else if (_Format.contains("HOTPOINT")) return  0; 
			 else if (_Format.contains("INGLIS")) return  3; 
			 else if (_Format.contains("JENN-AIR")) return  3; 
			 else if (_Format.contains("KELVINATOR")) return  3; 
			 ...
			 else if (_Format.contains("NORGE")) return  3; 
			 else if (_Format.contains("ROPER")) return  1; 
			 ...
			 else if (_Format.contains("WHITE WESTIN")) return  3; 
