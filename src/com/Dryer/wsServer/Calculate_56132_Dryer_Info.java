...
public class Calculate_56132_Dryer_Info {

	//take the input from outside
		public static double  Calculate_56132_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0097003762;
...
//				int G_MFG_BND_NMValue = 	G_MFG_BND_NM(G_MFG_BND_NM);	 
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0097003762;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// *** Compute Linear Predictor; 
					 ...
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    2.74489889547553) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.15319833125208) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.71395351124896) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.40394795993667) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.14312081100762) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.87517788477744) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (     0.6580465515788) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (     0.4048039537315) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (     0.0368922683071) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (    -0.6063414010207) * _TEMP * _1_9; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("7084_J"))  return    1; 
			 ...
			 else if (_Format.contains("7670_T"))  return    10; 
			 ...
			 else if (_Format.contains("7744_K"))  return    0; 
			 ...
			 else if (_Format.contains("8035_U"))  return    2; 
			 ...
			 else if (_Format.contains("8038_M"))  return    2; 
			 ...
			 else if (_Format.contains("8060_C"))  return    4; 
			 ...
			 else if (_Format.contains("8078_V"))  return    2; 
			 ...
			 else if (_Format.contains("8129_F"))  return    3; 
			 ...
			 else if (_Format.contains("8129_Y"))  return    2; 
			 ...
			 else if (_Format.contains("8158_M"))  return    1; 
			 else if (_Format.contains("8158_O"))  return    7; 
			 else if (_Format.contains("8162_A"))  return    1; 
			 ...
			 else if (_Format.contains("8162_Q"))  return    10; 
			 ...
			 else if (_Format.contains("8180_C"))  return    3; 
			 ...
			 else if (_Format.contains("8254_P"))  return    0; 
