...
public class Calculate_32120_Dryer_Info {

	//take the input from outside
			public static double  Calculate_32120_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
				try {
					
					MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
					//this value needs to be modified ..
					if(ProResults ==null) return  0.0322061557;
					...
					int _DM_BAD  = 0;
					 ...
					 //*** Generate dummy variables for G_MFG_BND_NM ; 
						...
						if (G_MFG_BND_NMValue == 0 ) {
						 ...
						 if (_DM_BAD > 0 ) return  0.0322061557;
						    //_P0 = 0.1045190843; 
						    //_P1 = 0.8954809157; 
						...
						// *** Compute Linear Predictor; 
						 ...
						 //***  Effect: G_IRU ; 
						 _TEMP = 1; 
						 _LP0 = _LP0 + (    2.92852160512849) * _TEMP * _1_0; 
						 _LP0 = _LP0 + (    1.65934894199122) * _TEMP * _1_1; 
						 _LP0 = _LP0 + (    1.30220199555373) * _TEMP * _1_2; 
						 _LP0 = _LP0 + (    1.07441107009894) * _TEMP * _1_3; 
						 _LP0 = _LP0 + (    0.89030839777346) * _TEMP * _1_4; 
						 _LP0 = _LP0 + (     0.7165323408216) * _TEMP * _1_5; 
						 _LP0 = _LP0 + (    0.53335088379071) * _TEMP * _1_6; 
						 _LP0 = _LP0 + (    0.36487663297008) * _TEMP * _1_7; 
						 _LP0 = _LP0 + (    0.23795305901064) * _TEMP * _1_8; 
						 _LP0 = _LP0 + (    0.02424122169851) * _TEMP * _1_9; 
						 _LP0 = _LP0 + (   -0.40902940881202) * _TEMP * _1_10; 
			...
			public static int G_IRU(String _Format){
				...
				//else if (_Format.contains("4766_A"))  return  6; 
				 ...
				 else if (_Format.contains("7108_T"))  return  3; 
				 ...
				 else if (_Format.contains("7744_N"))  return  6; 
				 ...
				 else if (_Format.contains("7900F6"))  return  10; 
				 ...
				 else if (_Format.contains("7983_N"))  return  5; 
				 ...
				 else if (_Format.contains("8035_U"))  return  3; 
				 ...
				 else if (_Format.contains("8060_B"))  return  7; 
				 ...
				 else if (_Format.contains("8129_G"))  return  7; 
				 ...
				 else if (_Format.contains("8151_B"))  return  2; 
				 ...
				 else if (_Format.contains("8175_B"))  return  2; 
				 ...
				 else if (_Format.contains("8175_H"))  return  1; 
				 ...
				 else if (_Format.contains("8180_M"))  return  3; 
				 else if (_Format.contains("8181_A"))  return  4; 
				 ...
				 else if (_Format.contains("8206_G"))  return  2; 
				 ...
				 else if (_Format.contains("8206_R"))  return  2; 
				 ...
				 else if (_Format.contains("8368_J"))  return  5; 
				 ...
				 else if (_Format.contains("9266_A"))  return  2; 
