...
public class Calculate_26410_Dryer_Info {

	//take the input from outside
		public static double  Calculate_26410_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.009371742;
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.009371742;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// *** Compute Linear Predictor; 
					 ...
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    2.93949698912891) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.33332982700197) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.80745187523172) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.35975044360908) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.16980948504783) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.85906378772823) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.63745645084357) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    0.45561886497807) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (    0.27949454894717) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (   -0.05179711138707) * _TEMP * _1_9; 
					 _LP0 = _LP0 + (    -0.7445958464875) * _TEMP * _1_10; 
					...
					// ***  Effect: G_MDL_NO ; 
					 ...
					 //***  Effect: G_MFG_BND_NM ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    1.63744191533591) * _TEMP * _2_0; 
					 _LP0 = _LP0 + (    0.30796120811392) * _TEMP * _2_1; 
					 _LP0 = _LP0 + (   -0.23697869939386) * _TEMP * _2_2; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("4766_E"))  return  5; 
			 else if (_Format.contains("4766_G"))  return  11; 
			 else if (_Format.contains("4766_I"))  return  11; 
			 ...
			 else if (_Format.contains("6141_G"))  return  5; 
			 else if (_Format.contains("6141_H"))  return  9; 
			 else if (_Format.contains("6141_I"))  return  3; 
			 else if (_Format.contains("6141_J"))  return  5; 
			 else if (_Format.contains("6141_K"))  return  11; 
			 else if (_Format.contains("6141_L"))  return  11; 
			 else if (_Format.contains("6877_B"))  return  9; 
			 else if (_Format.contains("6877_E"))  return  9; 
			 else if (_Format.contains("7084_A"))  return  11; 
			 else if (_Format.contains("7084_B"))  return  11; 
			 else if (_Format.contains("7084_C"))  return  10; 
			 else if (_Format.contains("7084_D"))  return  9; 
			 else if (_Format.contains("7084_E"))  return  11; 
			 else if (_Format.contains("7084_F"))  return  9; 
			 else if (_Format.contains("7084_G"))  return  3; 
			 ...
			 else if (_Format.contains("7108_M"))  return  5; 
			 ...
			 else if (_Format.contains("7194_G"))  return  5; 
			 ...
			 else if (_Format.contains("7194_O"))  return  4; 
			 ...
			 else if (_Format.contains("7323_C"))  return  10; 
			 else if (_Format.contains("7323_E"))  return  8; 
			 else if (_Format.contains("7385_C"))  return  11; 
			 else if (_Format.contains("7385_E"))  return  3; 
			 ...
			 else if (_Format.contains("7385_W"))  return  11; 
			 ...
			 else if (_Format.contains("7670_F"))  return  8; 
			 else if (_Format.contains("7670_G"))  return  9; 
			 else if (_Format.contains("7670_I"))  return  11; 
			 else if (_Format.contains("7670_K"))  return  9; 
			 else if (_Format.contains("7670_M"))  return  7; 
			 else if (_Format.contains("7670_P"))  return  11; 
			 else if (_Format.contains("7670_R"))  return  9; 
			 else if (_Format.contains("7670_S"))  return  5; 
			 else if (_Format.contains("7670_T"))  return  4; 
			 else if (_Format.contains("7670_V"))  return  11; 
			 ...
			 else if (_Format.contains("7744_C"))  return  9; 
			 else if (_Format.contains("7744_D"))  return  2; 
			 else if (_Format.contains("7744_H"))  return  9; 
			 else if (_Format.contains("7744_J"))  return  8; 
			 else if (_Format.contains("7744_K"))  return  2; 
			 else if (_Format.contains("7744_N"))  return  11; 
			 else if (_Format.contains("7744_S"))  return  4; 
			 else if (_Format.contains("7900C3"))  return  11; 
			 else if (_Format.contains("7900E3"))  return  11; 
			 ...
			 else if (_Format.contains("7983_P"))  return  3; 
			 ...
			 else if (_Format.contains("8035_E"))  return  5; 
			 else if (_Format.contains("8035_F"))  return  7; 
			 else if (_Format.contains("8035_G"))  return  7; 
			 else if (_Format.contains("8035_H"))  return  11; 
			 else if (_Format.contains("8035_I"))  return  11; 
			 else if (_Format.contains("8035_J"))  return  9; 
			 else if (_Format.contains("8035_M"))  return  11; 
			 else if (_Format.contains("8035_O"))  return  4; 
			 else if (_Format.contains("8035_P"))  return  11; 
			 else if (_Format.contains("8035_Q"))  return  11; 
			 else if (_Format.contains("8035_S"))  return  8; 
			 else if (_Format.contains("8035_T"))  return  6; 
			 else if (_Format.contains("8035_U"))  return  11; 
			 else if (_Format.contains("8035_V"))  return  11; 
			 else if (_Format.contains("8035_W"))  return  3; 
			 else if (_Format.contains("8035_Y"))  return  1; 
			 else if (_Format.contains("8035_Z"))  return  11; 
			 else if (_Format.contains("8038_I"))  return  9; 
			 else if (_Format.contains("8038_K"))  return  4; 
			 ...
			 else if (_Format.contains("8038_Q"))  return  5; 
			 else if (_Format.contains("8038_S"))  return  5; 
			 ...
			 else if (_Format.contains("8060_B"))  return  11; 
			 ...
			 else if (_Format.contains("8060_S"))  return  3; 
			 ...
			 else if (_Format.contains("8066DO"))  return  11; 
			 ...
			 else if (_Format.contains("8066JA"))  return  11; 
			 else if (_Format.contains("8066LA"))  return  11; 
			 else if (_Format.contains("8066MB"))  return  3; 
			 else if (_Format.contains("8066ME"))  return  5; 
			 else if (_Format.contains("8066MG"))  return  4; 
			 else if (_Format.contains("8066NO"))  return  9; 
			 else if (_Format.contains("8066PC"))  return  2; 
			 else if (_Format.contains("8066PN"))  return  11; 
			 else if (_Format.contains("8066SL"))  return  11; 
			 ...
			 else if (_Format.contains("8078_E"))  return  11; 
			 else if (_Format.contains("8078_N"))  return  8; 
			 else if (_Format.contains("8078_V"))  return  5; 
			 else if (_Format.contains("8101_C"))  return  7; 
			 else if (_Format.contains("8101_K"))  return  11; 
			 else if (_Format.contains("8101_S"))  return  9; 
			 else if (_Format.contains("8101_T"))  return  11; 
			 ...
			 else if (_Format.contains("8129_B"))  return  11; 
			 ...
			 else if (_Format.contains("8129_U"))  return  11; 
			 ...
			 else if (_Format.contains("8129_Y"))  return  8; 
			 else if (_Format.contains("8129_Z"))  return  7; 
			 else if (_Format.contains("8147_A"))  return  9; 
			 else if (_Format.contains("8147_C"))  return  9; 
			 ...
			 else if (_Format.contains("8147_G"))  return  11; 
			 ...
			 else if (_Format.contains("8150_I"))  return  11; 
			 else if (_Format.contains("8150_K"))  return  11; 
			 else if (_Format.contains("8150_L"))  return  11; 
			 ...
			 else if (_Format.contains("8150_S"))  return  9; 
			 ...
			 else if (_Format.contains("8151_G"))  return  5; 
			 ...
			 else if (_Format.contains("8162_E"))  return  11; 
			 else if (_Format.contains("8162_F"))  return  4; 
			 else if (_Format.contains("8162_H"))  return  4; 
			 else if (_Format.contains("8162_I"))  return  8; 
			 ...
			 else if (_Format.contains("8162_Q"))  return  4; 
			 else if (_Format.contains("8162_R"))  return  11; 
			 else if (_Format.contains("8162_X"))  return  11; 
			 else if (_Format.contains("8162_Z"))  return  7; 
			 else if (_Format.contains("8175_A"))  return  4; 
			 else if (_Format.contains("8175_B"))  return  11; 
			 else if (_Format.contains("8175_D"))  return  11; 
			 else if (_Format.contains("8175_E"))  return  11; 
			 else if (_Format.contains("8175_F"))  return  4; 
			 ...
			 else if (_Format.contains("8180_D"))  return  2; 
			 ...
			 else if (_Format.contains("8180_I"))  return  11; 
			 ...
			 else if (_Format.contains("8206_C"))  return  11; 
			 ...
			 else if (_Format.contains("8206_P"))  return  2; 
			 else if (_Format.contains("8206_R"))  return  4; 
			 else if (_Format.contains("8206_S"))  return  5; 
			 else if (_Format.contains("8206_V"))  return  11; 
			 else if (_Format.contains("8227_A"))  return  5; 
			 ...
			 else if (_Format.contains("8254_A"))  return  9; 
			 else if (_Format.contains("8254_B"))  return  5; 
			 else if (_Format.contains("8254_C"))  return  2; 
			 else if (_Format.contains("8254_D"))  return  3; 
			 else if (_Format.contains("8254_E"))  return  11; 
			 else if (_Format.contains("8254_F"))  return  11; 
			 else if (_Format.contains("8254_G"))  return  3; 
			 else if (_Format.contains("8254_H"))  return  3; 
			 ...
			 else if (_Format.contains("8320_I"))  return  4; 
			 else if (_Format.contains("8320_L"))  return  7; 
			 ...
			 else if (_Format.contains("9702_V"))  return  5; 
			 ...
			 else if (_Format.contains("9722_A"))  return  9; 
		...
		public static int G_MFG_BND_NM(String _Format){
			...
			if (_Format.equalsIgnoreCase("ADMIRAL"))  return   3; 
			 if (_Format.equalsIgnoreCase("AMANA"))  return   2; 
			 if (_Format.equalsIgnoreCase("BOSCH"))  return   3; 
			 if (_Format.equalsIgnoreCase("CROSLEY"))  return   3; 
			 if (_Format.equalsIgnoreCase("ELECTROLUX"))  return   3; 
			 if (_Format.equalsIgnoreCase("ESTATE"))  return   1; 
			 if (_Format.equalsIgnoreCase("FISHERPAYKEL"))  return   2; 
			 if (_Format.equalsIgnoreCase("FRIGIDAIRE"))  return   2; 
			 if (_Format.equalsIgnoreCase("GALAXY"))  return   3; 
			 if (_Format.equalsIgnoreCase("GALLERY"))  return   3; 
			 if (_Format.equalsIgnoreCase("GE"))  return   0; 
			 if (_Format.equalsIgnoreCase("GE CAFE"))  return   3; 
			 if (_Format.equalsIgnoreCase("GE PROFILE"))  return   2; 
			 if (_Format.equalsIgnoreCase("GIBSON"))  return   3; 
			 if (_Format.equalsIgnoreCase("HAIER"))  return   3; 
			 if (_Format.equalsIgnoreCase("HOTPOINT"))  return   0; 
			 if (_Format.equalsIgnoreCase("INGLIS"))  return   3; 
			 if (_Format.equalsIgnoreCase("JENN-AIR"))  return   3; 
			 if (_Format.equalsIgnoreCase("KELVINATOR"))  return   3; 
			 if (_Format.equalsIgnoreCase("KENMORE"))  return   2; 
			 if (_Format.equalsIgnoreCase("KENMORE ELIT"))  return   3; 
			 if (_Format.equalsIgnoreCase("KIRKLAND"))  return   3; 
			 if (_Format.equalsIgnoreCase("KITCHENAID"))  return   2; 
			 if (_Format.equalsIgnoreCase("LG"))  return   3; 
			 if (_Format.equalsIgnoreCase("MAGIC CHEF"))  return   3; 
			 if (_Format.equalsIgnoreCase("MAYTAG"))  return   3; 
			 if (_Format.equalsIgnoreCase("MONTGMY WARD"))  return   3; 
			 if (_Format.equalsIgnoreCase("NORGE"))  return   3; 
			 if (_Format.equalsIgnoreCase("ROPER"))  return   1; 
			 if (_Format.equalsIgnoreCase("SAMSUNG"))  return   3; 
			 if (_Format.equalsIgnoreCase("SEARS"))  return   1; 
			 if (_Format.equalsIgnoreCase("WHIRLPOOL"))  return   3; 
			 if (_Format.equalsIgnoreCase("WHITE WESTIN"))  return   3; 
