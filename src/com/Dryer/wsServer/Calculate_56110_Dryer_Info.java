...
public class Calculate_56110_Dryer_Info {

	//take the input from outside
		public static double  Calculate_56110_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.03566025;
...
//				int G_MFG_BND_NMValue = 	G_MFG_BND_NM(G_MFG_BND_NM);	 
				...
				//*** Check _73260 for missing values ; 
					...
					//	 *** Check _14225 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_14225")) -0.0 <=0.000000000000001  )  
	      				    _DM_BAD = 1; 
						  
					//	 *** Check _11130 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_11130")) -0.0 <=0.000000000000001  )  
	      				    _DM_BAD = 1; 
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.03566025;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// ***  Effect: _73260 ;  
					 ...
					 _LP0 = _LP0 + (   -54.4802788635971 * _TEMP); 
					  
					 //***  Effect: _14625 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_14625")) ; 
					 _LP0 = _LP0 + (     17.383696640169 * _TEMP);  
					  
					// ***  Effect: _14225 ;  
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_14225")) ; 
					 _LP0 = _LP0 + (    19.1168046337573 * _TEMP); 
					  
					 //***  Effect: _11130 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_11130")) ; 
					 _LP0 = _LP0 + (   -37.2986686062056 * _TEMP); 
					 
					 
					  
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    1.47488880588317) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    0.89103176628217) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    0.63017730914481) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    0.56520624438307) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    0.32057916408212) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.12878265334562) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (   -0.03771819004596) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (   -0.23330903857269) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (   -0.46786466757138) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (   -0.60677546788905) * _TEMP * _1_9; 
					 _LP0 = _LP0 + (   -0.81753474207547) * _TEMP * _1_10; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("6141_E")) return  0; 
			 ...
			 else if (_Format.contains("7084_J")) return  5; 
			 ...
			 else if (_Format.contains("7108_T")) return  10; 
			 ...
			 else if (_Format.contains("7385_E")) return  7; 
			 ...
			 else if (_Format.contains("7385_N")) return  5; 
			 ...
			 else if (_Format.contains("7385_V")) return  7; 
			 else if (_Format.contains("7385_W")) return  4; 
			 else if (_Format.contains("7385_Z")) return  4; 
			 ...
			 else if (_Format.contains("7670_S")) return  3; 
			 ...
			 else if (_Format.contains("7744_H")) return  4; 
			 ...
			 else if (_Format.contains("7900R6")) return  3; 
			 else if (_Format.contains("7900T4")) return  2; 
			 else if (_Format.contains("7900U3")) return  4; 
			 else if (_Format.contains("7908F2")) return  9; 
			 else if (_Format.contains("7908I5")) return  7; 
			 ...
			 else if (_Format.contains("7983_L")) return  10; 
			 ...
			 else if (_Format.contains("8035_A")) return  3; 
			 else if (_Format.contains("8035_B")) return  3; 
			 ...
			 else if (_Format.contains("8035_P")) return  2; 
			 ...
			 else if (_Format.contains("8060_G")) return  4; 
			 ...
			 else if (_Format.contains("8060_P")) return  3; 
			 ...
			 else if (_Format.contains("8066GP")) return  1; 
			 ...
			 else if (_Format.contains("8066SL")) return  3; 
			 else if (_Format.contains("8066SM")) return  3; 
			 else if (_Format.contains("8066ZZ")) return  11; 
			 else if (_Format.contains("8078_A")) return  11; 
			 ...
			 else if (_Format.contains("8101_Y")) return  0; 
			 ...
			 else if (_Format.contains("8107_S")) return  4; 
			 ...
			 else if (_Format.contains("8129_P")) return  3; 
			 ...
			 else if (_Format.contains("8150_C")) return  4; 
			 ...
			 else if (_Format.contains("8150_K")) return  3; 
			 ...
			 else if (_Format.contains("8158_K")) return  3; 
			 ...
			 else if (_Format.contains("8162_B")) return  1; 
			 ...
			 else if (_Format.contains("8175_G")) return  5; 
			 ...
			 else if (_Format.contains("8181_W")) return  5; 
			 ...
			 else if (_Format.contains("8227_G")) return  7; 
			 else if (_Format.contains("8227_H")) return  1; 
			 ...
			 else if (_Format.contains("8254_G")) return  5; 
			 ...
			 else if (_Format.contains("8935_F")) return  1; 
			 else if (_Format.contains("8935_M")) return  4; 
			 else if (_Format.contains("8935_P")) return  1; 
			 else if (_Format.contains("8935_S")) return  1; 
			 else if (_Format.contains("8935_T")) return  1; 
			 ...
			 else if (_Format.contains("9664_A")) return  4; 
			 ...
			 else if (_Format.contains("9702_S")) return  10; 
			 ...
			 else if (_Format.contains("9722_A")) return  3; 
			 ...
			 else if (_Format.contains("9734_A")) return  4; 
