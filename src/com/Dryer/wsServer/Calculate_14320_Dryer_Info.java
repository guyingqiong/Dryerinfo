...
public class Calculate_14320_Dryer_Info {
	//take the input from outside
	public static double  Calculate_14320_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
		try {
			
			MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
			//this value needs to be modified ..
			if(ProResults ==null) return  0.03562848465618;
...
//			int G_ITM_AGE2Value =G_ITM_AGE2(G_ITM_AGE2);
			...
			//*** Check _14220 for missing values ; 
			 ...
			 //*** Generate dummy variables for G_MFG_BND_NM ; 
				...
				// ***  Effect: _14220 ;  
				 ...
				 _LP0 = _LP0 + (   32.7234922658971 * _TEMP); 
				  
				 //***  Effect: _14320 ; 
				 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_14320")) ; 
				 _LP0 = _LP0 + (    -10.5051089759561 * _TEMP); 
				  
				// ***  Effect: _56320 ;  
				 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_56320")) ; 
				 _LP0 = _LP0 + (   -32.4359056139641 * _TEMP); 
				  
				 //***  Effect: _73390 ; 
				 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_73390")) ; 
				 _LP0 = _LP0 + (    -31.7649421527961 * _TEMP); 
				 
			
				  
				 //***  Effect: G_IRU ; 
				 _TEMP = 1; 
				 _LP0 = _LP0 + (     1.9483554792227) * _TEMP * _1_0; 
				 _LP0 = _LP0 + (    1.91681218753128) * _TEMP * _1_1; 
				 _LP0 = _LP0 + (    1.37812027511833) * _TEMP * _1_2; 
				 _LP0 = _LP0 + (    1.15826101309917) * _TEMP * _1_3; 
				 _LP0 = _LP0 + (    0.95811719878183) * _TEMP * _1_4; 
				 _LP0 = _LP0 + (    0.73857813663727) * _TEMP * _1_5; 
				 _LP0 = _LP0 + (    0.55422024209311) * _TEMP * _1_6; 
				 _LP0 = _LP0 + (    0.40892732503876) * _TEMP * _1_7; 
				 _LP0 = _LP0 + (    0.28690725482572) * _TEMP * _1_8; 
				 _LP0 = _LP0 + (   -0.02715734730689) * _TEMP * _1_9; 
				 _LP0 = _LP0 + (   -0.52258273109797) * _TEMP * _1_10; 
				...
				/* _TEMP = 1; 
				 ...
				 //***  Effect: G_MFG_BND_NM ; 
				 _TEMP = 1; 
				 _LP0 = _LP0 + (    0.89185827717458) * _TEMP * _2_0; 
				 _LP0 = _LP0 + (    0.30559647018325) * _TEMP * _2_1; 
				 _LP0 = _LP0 + (   -0.15582523333509) * _TEMP * _2_2; 
	...
	public static int G_IRU(String _Format){
		...
		//else if (_Format.contains("4766_A"))  return  6; 
		 ...
		 else if (_Format.contains("4766_C"))  return  4; 
		 ...
		 else if (_Format.contains("4766_J"))  return  7; 
		 ...
		 else if (_Format.contains("6141_A"))  return  2; 
		 ...
		 else if (_Format.contains("7084_A"))  return  10; 
		 ...
		 else if (_Format.contains("7108_M"))  return  4; 
		 else if (_Format.contains("7108_N"))  return  4; 
		 else if (_Format.contains("7108_O"))  return  4; 
		 ...
		 else if (_Format.contains("7385_M"))  return  5; 
		 ...
		 else if (_Format.contains("7385_Z"))  return  7; 
		 ...
		 else if (_Format.contains("7900E3"))  return  7; 
		 ...
		 else if (_Format.contains("7908F2"))  return  2; 
		 ...
		 else if (_Format.contains("8035_C"))  return  5; 
		 ...
		 else if (_Format.contains("8035_P"))  return  3; 
		 ...
		 else if (_Format.contains("8038_O"))  return  0; 
		 else if (_Format.contains("8038_Q"))  return  4; 
		 else if (_Format.contains("8038_S"))  return  6; 
		 else if (_Format.contains("8038_U"))  return  8; 
		 else if (_Format.contains("8038_V"))  return  3; 
		 ...
		 else if (_Format.contains("8060_E"))  return  10; 
		 ...
		 else if (_Format.contains("8060_T"))  return  4; 
		 ...
		 else if (_Format.contains("8060_Z"))  return  5; 
		 ...
		 else if (_Format.contains("8066JA"))  return  10; 
		 ...
		 else if (_Format.contains("8066SM"))  return  8; 
		 ...
		 else if (_Format.contains("8101_C"))  return  4; 
		 ...
		 else if (_Format.contains("8107_A"))  return  10; 
		 ...
		 else if (_Format.contains("8162_Z"))  return  2; 
		 ...
		 else if (_Format.contains("8180_K"))  return  7; 
		 else if (_Format.contains("8180_L"))  return  4; 
		 else if (_Format.contains("8180_M"))  return  6; 
		 else if (_Format.contains("8181_A"))  return  6; 
		 else if (_Format.contains("8181_F"))  return  2; 
		 else if (_Format.contains("8181_S"))  return  5; 
		 else if (_Format.contains("8181_W"))  return  4; 
		 ...
		 else if (_Format.contains("8206_D"))  return  8; 
		 ...
		 else if (_Format.contains("8227_F"))  return  5; 
		 ...
		 else if (_Format.contains("8245_F"))  return  5; 
		 ...
		 else if (_Format.contains("8254_D"))  return  6; 
		 ...
		 else if (_Format.contains("8254_H"))  return  4; 
		 else if (_Format.contains("8254_I"))  return  11; 
		 else if (_Format.contains("8254_J"))  return  1; 
		 ...
		 else if (_Format.contains("8320_G"))  return  6; 
		 ...
		 else if (_Format.contains("8320_X"))  return  8; 
		 ...
		 else if (_Format.contains("9265_A"))  return  0; 
		 ...
		 else if (_Format.contains("9709_A"))  return  3; 
		 ...
		 else if (_Format.contains("9759_A"))  return  3; 
		 else if (_Format.contains("9759_B"))  return  4; 
		 else if (_Format.contains("9759_N"))  return  3; 
	...
	public static int G_MFG_BND_NM(String _Format){
		...
		//else if (_Format.equalsIgnoreCase("ADMIRAL")) return  2; 
		 ...
		 else if (_Format.equalsIgnoreCase("BOSCH")) return  3; 
		 else if (_Format.equalsIgnoreCase("CROSLEY")) return  3; 
		 else if (_Format.equalsIgnoreCase("ELECTROLUX")) return  3; 
		 else if (_Format.equalsIgnoreCase("ESTATE")) return  3; 
		 else if (_Format.equalsIgnoreCase("FISHERPAYKEL")) return  2; 
		 else if (_Format.equalsIgnoreCase("FRIGIDAIRE")) return  3; 
		 else if (_Format.equalsIgnoreCase("GALAXY")) return  3; 
		 ...
		 else if (_Format.equalsIgnoreCase("HAIER")) return  3; 
		 ...
		 else if (_Format.equalsIgnoreCase("KENMORE ELIT")) return  3; 
		 else if (_Format.equalsIgnoreCase("KIRKLAND")) return  3; 
		 else if (_Format.equalsIgnoreCase("KITCHENAID")) return  2; 
		 else if (_Format.equalsIgnoreCase("LG")) return  0; 
		 else if (_Format.equalsIgnoreCase("MAGIC CHEF")) return  1; 
		 else if (_Format.equalsIgnoreCase("MAYTAG")) return  1; 
		 else if (_Format.equalsIgnoreCase("MONTGMY WARD")) return  3; 
		 else if (_Format.equalsIgnoreCase("NORGE")) return  0; 
		 else if (_Format.equalsIgnoreCase("ROPER")) return  3; 
		 else if (_Format.equalsIgnoreCase("SAMSUNG")) return  3; 
		 else if (_Format.equalsIgnoreCase("SEARS")) return  1; 
