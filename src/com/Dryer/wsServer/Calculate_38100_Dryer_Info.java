...
public class Calculate_38100_Dryer_Info {

	//take the input from outside
		public static double  Calculate_38100_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0073319432;
				...
				int _DM_BAD  = 0;
						...
						// *** Generate dummy variables for G_IRU ; 
						 double _1_0 =0.0 ,_1_1  =0.0,_1_2 =0.0, _1_3 =0.0 ,_1_4 =0.0, _1_5  =0.0,_1_6 =0.0 ,_1_7  =0.0;
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0073319432;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// *** Compute Linear Predictor; 
					 ...
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    1.88135600981322) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    1.35563253136672) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.06836313977813) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    0.72720693699216) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    0.41268965264288) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (   -0.01087398977839) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (   -0.52921628804108) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (   -1.09688976747205) * _TEMP * _1_7; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("4766_L"))  return    8; 
			 else if (_Format.contains("4766_S"))  return    8; 
			 else if (_Format.contains("4766_T"))  return    8; 
			 ...
			 else if (_Format.contains("6141_F"))  return    8; 
			 else if (_Format.contains("6141_G"))  return    8; 
			 else if (_Format.contains("6141_H"))  return    4; 
			 ...
			 else if (_Format.contains("6877_B"))  return    3; 
			 else if (_Format.contains("6877_E"))  return    4; 
			 else if (_Format.contains("7084_A"))  return    8; 
			 else if (_Format.contains("7084_B"))  return    8; 
			 else if (_Format.contains("7084_C"))  return    7; 
			 else if (_Format.contains("7084_D"))  return    7; 
			 else if (_Format.contains("7084_E"))  return    8; 
			 else if (_Format.contains("7084_F"))  return    7; 
			 else if (_Format.contains("7084_G"))  return    8; 
			 else if (_Format.contains("7084_H"))  return    8; 
			 else if (_Format.contains("7084_I"))  return    8; 
			 else if (_Format.contains("7084_J"))  return    8; 
			 ...
			 else if (_Format.contains("7108_T"))  return    2; 
			 else if (_Format.contains("7108_X"))  return    3; 
			 ...
			 else if (_Format.contains("7194_L"))  return    8; 
			 ...
			 else if (_Format.contains("7385_C"))  return    8; 
			 else if (_Format.contains("7385_E"))  return    8; 
			 else if (_Format.contains("7385_F"))  return    8; 
			 else if (_Format.contains("7385_G"))  return    8; 
			 else if (_Format.contains("7385_H"))  return    5; 
			 else if (_Format.contains("7385_I"))  return    8; 
			 else if (_Format.contains("7385_J"))  return    8; 
			 else if (_Format.contains("7385_L"))  return    8; 
			 else if (_Format.contains("7385_M"))  return    8; 
			 else if (_Format.contains("7385_N"))  return    8; 
			 else if (_Format.contains("7385_O"))  return    8; 
			 else if (_Format.contains("7385_P"))  return    8; 
			 else if (_Format.contains("7385_Q"))  return    8; 
			 else if (_Format.contains("7385_R"))  return    8; 
			 else if (_Format.contains("7385_S"))  return    8; 
			 ...
			 else if (_Format.contains("7435_F"))  return    1; 
			 else if (_Format.contains("7670_B"))  return    5; 
			 else if (_Format.contains("7670_D"))  return    8; 
			 else if (_Format.contains("7670_F"))  return    1; 
			 ...
			 else if (_Format.contains("7670_X"))  return    8; 
			 ...
			 else if (_Format.contains("7908I5"))  return    8; 
			 else if (_Format.contains("7908L1"))  return    3; 
			 else if (_Format.contains("7908M1"))  return    3; 
			 ...
			 else if (_Format.contains("8035_C"))  return    8; 
			 ...
			 else if (_Format.contains("8035_I"))  return    8; 
			 ...
			 else if (_Format.contains("8035_V"))  return    8; 
			 else if (_Format.contains("8035_W"))  return    8; 
			 else if (_Format.contains("8035_Y"))  return    8; 
			 ...
			 else if (_Format.contains("8038_O"))  return    8; 
			 else if (_Format.contains("8038_Q"))  return    7; 
			 else if (_Format.contains("8038_S"))  return    6; 
			 else if (_Format.contains("8038_U"))  return    8; 
			 else if (_Format.contains("8038_V"))  return    8; 
			 else if (_Format.contains("8060R1"))  return    8; 
			 else if (_Format.contains("8060_A"))  return    8; 
			 else if (_Format.contains("8060_B"))  return    0; 
			 else if (_Format.contains("8060_C"))  return    8; 
			 else if (_Format.contains("8060_D"))  return    1; 
			 else if (_Format.contains("8060_E"))  return    8; 
			 else if (_Format.contains("8060_F"))  return    4; 
			 ...
			 else if (_Format.contains("8060_M"))  return    8; 
			 else if (_Format.contains("8060_N"))  return    8; 
			 else if (_Format.contains("8060_O"))  return    8; 
			 else if (_Format.contains("8060_P"))  return    8; 
			 else if (_Format.contains("8060_Q"))  return    8; 
			 else if (_Format.contains("8060_S"))  return    0; 
			 else if (_Format.contains("8060_T"))  return    8; 
			 else if (_Format.contains("8060_U"))  return    8; 
			 else if (_Format.contains("8060_V"))  return    5; 
			 else if (_Format.contains("8060_W"))  return    8; 
			 else if (_Format.contains("8060_X"))  return    8; 
			 else if (_Format.contains("8060_Z"))  return    8; 
			 else if (_Format.contains("8066AL"))  return    8; 
			 else if (_Format.contains("8066BR"))  return    8; 
			 else if (_Format.contains("8066DO"))  return    8; 
			 else if (_Format.contains("8066GP"))  return    8; 
			 else if (_Format.contains("8066HA"))  return    8; 
			 else if (_Format.contains("8066HO"))  return    8; 
			 ...
			 else if (_Format.contains("8066MG"))  return    8; 
			 ...
			 else if (_Format.contains("8066SM"))  return    2; 
			 else if (_Format.contains("8066ZZ"))  return    8; 
			 ...
			 else if (_Format.contains("8101_X"))  return    8; 
			 else if (_Format.contains("8101_Y"))  return    8; 
			 else if (_Format.contains("8101_Z"))  return    8; 
			 else if (_Format.contains("8107_A"))  return    5; 
			 else if (_Format.contains("8107_C"))  return    8; 
			 else if (_Format.contains("8107_D"))  return    8; 
			 else if (_Format.contains("8107_E"))  return    8; 
			 else if (_Format.contains("8107_F"))  return    8; 
			 else if (_Format.contains("8107_L"))  return    1; 
			 else if (_Format.contains("8107_S"))  return    6; 
			 else if (_Format.contains("8129_A"))  return    8; 
			 else if (_Format.contains("8129_B"))  return    8; 
			 ...
			 else if (_Format.contains("8129_U"))  return    8; 
			 ...
			 else if (_Format.contains("8129_Z"))  return    3; 
			 ...
			 else if (_Format.contains("8150_A"))  return    8; 
			 else if (_Format.contains("8150_B"))  return    8; 
			 else if (_Format.contains("8150_C"))  return    8; 
			 else if (_Format.contains("8150_E"))  return    8; 
			 else if (_Format.contains("8150_G"))  return    8; 
			 else if (_Format.contains("8150_I"))  return    8; 
			 else if (_Format.contains("8150_K"))  return    0; 
			 else if (_Format.contains("8150_L"))  return    8; 
			 else if (_Format.contains("8150_O"))  return    8; 
			 else if (_Format.contains("8150_P"))  return    3; 
			 else if (_Format.contains("8150_Q"))  return    8; 
			 else if (_Format.contains("8150_R"))  return    8; 
			 else if (_Format.contains("8150_S"))  return    6; 
			 else if (_Format.contains("8150_T"))  return    8; 
			 else if (_Format.contains("8150_W"))  return    8; 
			 else if (_Format.contains("8151_B"))  return    3; 
			 ...
			 else if (_Format.contains("8158_K"))  return    8; 
			 else if (_Format.contains("8158_L"))  return    8; 
			 else if (_Format.contains("8158_M"))  return    8; 
			 else if (_Format.contains("8158_O"))  return    8; 
			 else if (_Format.contains("8162_A"))  return    8; 
			 ...
			 else if (_Format.contains("8175_A"))  return    8; 
			 else if (_Format.contains("8175_B"))  return    8; 
			 else if (_Format.contains("8175_D"))  return    8; 
			 ...
			 else if (_Format.contains("8175_I"))  return    8; 
			 ...
			 else if (_Format.contains("8206_V"))  return    8; 
			 ...
			 else if (_Format.contains("8227_F"))  return    8; 
			 else if (_Format.contains("8227_G"))  return    5; 
			 else if (_Format.contains("8227_H"))  return    8; 
			 ...
			 else if (_Format.contains("8254_N"))  return    5; 
			 else if (_Format.contains("8254_O"))  return    5; 
			 else if (_Format.contains("8254_P"))  return    8; 
			 else if (_Format.contains("8254_R"))  return    8; 
			 else if (_Format.contains("8320_G"))  return    4; 
			 else if (_Format.contains("8320_H"))  return    3; 
			 else if (_Format.contains("8320_I"))  return    6; 
			 else if (_Format.contains("8320_L"))  return    5; 
			 else if (_Format.contains("8320_M"))  return    3; 
			 else if (_Format.contains("8320_P"))  return    3; 
			 ...
			 else if (_Format.contains("8368_P"))  return    5; 
			 else if (_Format.contains("8368_R"))  return    7; 
			 else if (_Format.contains("8368_S"))  return    3; 
			 else if (_Format.contains("8368_X"))  return    6; 
			 else if (_Format.contains("8935_A"))  return    2; 
			 else if (_Format.contains("8935_B"))  return    8; 
			 else if (_Format.contains("8935_C"))  return    1; 
			 else if (_Format.contains("8935_D"))  return    6; 
			 else if (_Format.contains("8935_F"))  return    8; 
			 else if (_Format.contains("8935_M"))  return    2; 
			 else if (_Format.contains("8935_P"))  return    2; 
			 else if (_Format.contains("8935_S"))  return    8; 
			 else if (_Format.contains("8935_T"))  return    3; 
			 else if (_Format.contains("9197_A"))  return    7; 
			 else if (_Format.contains("9263_A"))  return    8; 
			 else if (_Format.contains("9265_A"))  return    8; 
			 else if (_Format.contains("9266_A"))  return    8; 
			 ...
			 else if (_Format.contains("9700_A"))  return    3; 
			 ...
			 else if (_Format.contains("9759_A"))  return    4; 
			 else if (_Format.contains("9759_B"))  return    3; 
			 else if (_Format.contains("9759_N"))  return    5; 
