...
public class Calculate_14240_Dryer_Info {
	//take the input from outside
		public static double  Calculate_14240_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0160030592;
...
//				int G_MFG_BND_NMValue = 	G_MFG_BND_NM(G_MFG_BND_NM);	 
				...
				int _DM_BAD  = 0;
				//*** Check _12120 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_12120")) -0.0 <=0.000000000000001  )  
	         				    _DM_BAD = 1; 
					...
					//	 *** Check _14230 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_14230")) -0.0 <=0.000000000000001  )  
	      				    _DM_BAD = 1; 
					...
					//	 *** Check _93860 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_93860")) -0.0 <=0.000000000000001  )  
	      				    _DM_BAD = 1; 
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0160030592;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// ***  Effect: _12120 ;  
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_12120")) ; 
					 _LP0 = _LP0 + (    -74.8679331511155 * _TEMP); 
					  
					 //***  Effect: _14220 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_14220")) ; 
					 _LP0 = _LP0 + (    16.9057966782811 * _TEMP); 
					  
					// ***  Effect: _14230 ;  
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_14230")) ; 
					 _LP0 = _LP0 + (   16.9349903049391 * _TEMP); 
					  
					 //***  Effect: _14320 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_14320")) ; 
					 _LP0 = _LP0 + (    9.56311411292506 * _TEMP); 
					 
					// ***  Effect: _16120 ;  
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_16120")) ; 
					 _LP0 = _LP0 + (   20.4617471156352 * _TEMP); 
					  
					 //***  Effect: _93860 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_93860")) ; 
					 _LP0 = _LP0 + (   -18.4234657329376 * _TEMP); 
					 
					 
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    3.25743483538323) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    1.70977858975176) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.57975225598853) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.39249204927801) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.15875555605866) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    1.01450102785131) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.75851725039927) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (     0.5232220229633) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (    0.25373714446581) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (   -0.23448888771969) * _TEMP * _1_9; 
					 _LP0 = _LP0 + (   -0.72231781656448) * _TEMP * _1_10; 

					  
					// ***  Effect: G_ITM_AGE2 ; 
					_TEMP = 1; 
                   _LP0 = _LP0 + (   -1.25940024560634) * _TEMP * _2_0; 
                   _LP0 = _LP0 + (    0.19824050409601) * _TEMP * _2_1; 
                   _LP0 = _LP0 + (    0.52542441081061) * _TEMP * _2_2; 
                   _LP0 = _LP0 + (    0.77219332303847) * _TEMP * _2_3; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			else if (_Format.contains("4766_A"))  return   1; 
			 ...
			 else if (_Format.contains("6141_C"))  return   9; 
			 else if (_Format.contains("6141_E"))  return   7; 
			 ...
			 else if (_Format.contains("7108_X"))  return   4; 
			 ...
			 else if (_Format.contains("7194_O"))  return   9; 
			 ...
			 else if (_Format.contains("7385_F"))  return   10; 
			 ...
			 else if (_Format.contains("7670_P"))  return   8; 
			 ...
			 else if (_Format.contains("7744_B"))  return   3; 
			 ...
			 else if (_Format.contains("7744_K"))  return   3; 
			 ...
			 else if (_Format.contains("7908F2"))  return   6; 
			 ...
			 else if (_Format.contains("7983_O"))  return   7; 
			 ...
			 else if (_Format.contains("8035_G"))  return   11; 
			 ...
			 else if (_Format.contains("8035_S"))  return   11; 
			 ...
			 else if (_Format.contains("8060_C"))  return   2; 
			 ...
			 else if (_Format.contains("8060_Q"))  return   0; 
			 else if (_Format.contains("8060_S"))  return   6; 
			 else if (_Format.contains("8060_T"))  return   8; 
			 ...
			 else if (_Format.contains("8078_B"))  return   8; 
			 ...
			 else if (_Format.contains("8107_C"))  return   2; 
			 ...
			 else if (_Format.contains("8129_A"))  return   5; 
			 ...
			 else if (_Format.contains("8147_F"))  return   9; 
			 else if (_Format.contains("8147_G"))  return   6; 
			 else if (_Format.contains("8147_L"))  return   8; 
			 else if (_Format.contains("8147_O"))  return   11; 
			 ...
			 else if (_Format.contains("8150_E"))  return   11; 
			 ...
			 else if (_Format.contains("8151_L"))  return   4; 
			 ...
			 else if (_Format.contains("8162_B"))  return   3; 
			 ...
			 else if (_Format.contains("8162_X"))  return   5; 
			 ...
			 else if (_Format.contains("8175_E"))  return   1; 
			 ...
			 else if (_Format.contains("8180_A"))  return   2; 
			 else if (_Format.contains("8180_B"))  return   4; 
			 ...
			 else if (_Format.contains("8180_F"))  return   11; 
			 ...
			 else if (_Format.contains("8181_A"))  return   5; 
			 ...
			 else if (_Format.contains("8254_C"))  return   7; 
			 else if (_Format.contains("8254_D"))  return   1; 
			 ...
			 else if (_Format.contains("8254_I"))  return   3; 
			 ...
			 else if (_Format.contains("8254_N"))  return   4; 
			 ...
			 else if (_Format.contains("8320_I"))  return   9; 
			 else if (_Format.contains("8320_L"))  return   9; 
			 else if (_Format.contains("8320_M"))  return   8; 
			 else if (_Format.contains("8320_P"))  return   6; 
			 ...
			 else if (_Format.contains("8368_R"))  return   11; 
			 else if (_Format.contains("8368_S"))  return   8; 
			 else if (_Format.contains("8368_X"))  return   8; 
			 else if (_Format.contains("8935_A"))  return   11; 
			 else if (_Format.contains("8935_B"))  return   11; 
