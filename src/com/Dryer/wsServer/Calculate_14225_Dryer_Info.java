...
public class Calculate_14225_Dryer_Info {

	//take the input from outside
		public static double  Calculate_14225_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.01035764471238;
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0104649148;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// ***  Effect: _14330 ;  
					 ...
					 _LP0 = _LP0 + (    -42.046213387933 * _TEMP); 
					  
					 //***  Effect: _14120 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_14120")) ; 
					 _LP0 = _LP0 + (    41.3911731849369 * _TEMP); 
					 ...
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    2.54067529332911) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (     2.0491764581133) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.70862832726195) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.36625868420676) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.10259329574992) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.86857324424271) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.69096455522066) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    0.51551658635266) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (    0.31162818872506) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (   -0.28211278968666) * _TEMP * _1_9; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("4766_K"))  return  1; 
			 ...
			 else if (_Format.contains("7084_B"))  return  1; 
			 ...
			 else if (_Format.contains("7385_H"))  return  3; 
			 else if (_Format.contains("7385_I"))  return  10; 
			 ...
			 else if (_Format.contains("7670_B"))  return  2; 
			 ...
			 else if (_Format.contains("7983_K"))  return  4; 
			 ...
			 else if (_Format.contains("8035_O"))  return  3; 
			 else if (_Format.contains("8035_P"))  return  10; 
			 else if (_Format.contains("8035_Q"))  return  1; 
			 ...
			 else if (_Format.contains("8038_K"))  return  3; 
			 ...
			 else if (_Format.contains("8078_E"))  return  10; 
			 ...
			 else if (_Format.contains("8147_E"))  return  3; 
			 ...
			 else if (_Format.contains("8150_O"))  return  0; 
			 ...
			 else if (_Format.contains("8150_S"))  return  4; 
			 ...
			 else if (_Format.contains("8158_C"))  return  10; 
			 else if (_Format.contains("8158_D"))  return  4; 
			 ...
			 else if (_Format.contains("8158_O"))  return  3; 
			 ...
			 else if (_Format.contains("8162_Q"))  return  2; 
			 ...
			 else if (_Format.contains("8180_A"))  return  0; 
			 ...
			 else if (_Format.contains("8180_G"))  return  8; 
			 ...
			 else if (_Format.contains("8206_L"))  return  3; 
			 ...
			 else if (_Format.contains("8206_P"))  return  10; 
			 ...
			 else if (_Format.contains("8254_C"))  return  4; 
			 else if (_Format.contains("8254_D"))  return  0; 
			 ...
			 else if (_Format.contains("8935_D"))  return  8; 
