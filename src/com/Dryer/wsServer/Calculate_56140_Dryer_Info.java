...
public class Calculate_56140_Dryer_Info {

	//take the input from outside
		public static double  Calculate_56140_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0084198359;
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0084198359;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// *** Compute Linear Predictor; 
					 ...
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (     2.8909499303221) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.28150917903801) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.74830424169497) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.42231038321667) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.18374327213867) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.86691955581621) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.54823512390187) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    0.29999581011994) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (   -0.06814872528828) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (   -0.61103362611153) * _TEMP * _1_9; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("4766_K"))  return     0; 
			 ...
			 else if (_Format.contains("6141_G"))  return     1; 
			 ...
			 else if (_Format.contains("6877_E"))  return     2; 
			 ...
			 else if (_Format.contains("7194_A"))  return     3; 
			 ...
			 else if (_Format.contains("7289_A"))  return     4; 
			 ...
			 else if (_Format.contains("7435_A"))  return     2; 
			 ...
			 else if (_Format.contains("7670_I"))  return     2; 
			 ...
			 else if (_Format.contains("8035_Q"))  return     5; 
			 else if (_Format.contains("8035_S"))  return     4; 
			 else if (_Format.contains("8035_T"))  return     3; 
			 ...
			 else if (_Format.contains("8038_M"))  return     3; 
			 ...
			 else if (_Format.contains("8060_E"))  return     5; 
			 ...
			 else if (_Format.contains("8060_M"))  return     0; 
			 ...
			 else if (_Format.contains("8129_R"))  return     3; 
			 ...
			 else if (_Format.contains("8129_X"))  return     4; 
			 ...
			 else if (_Format.contains("8147_D"))  return     2; 
			 ...
			 else if (_Format.contains("8162_E"))  return     2; 
			 ...
			 else if (_Format.contains("8162_R"))  return     2; 
			 else if (_Format.contains("8162_X"))  return     10; 
			 else if (_Format.contains("8162_Z"))  return     10; 
			 ...
			 else if (_Format.contains("8180_E"))  return     1; 
			 ...
			 else if (_Format.contains("8206_S"))  return     2; 
			 ...
			 else if (_Format.contains("9701_A"))  return     2; 
			 ...
			 else if (_Format.contains("9784_A"))  return     9; 
