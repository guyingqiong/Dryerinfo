...
public class Calculate_12120_Dryer_Info {

	//take the input from outside
		public static double  Calculate_12120_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.01296405421331;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// ***  Effect: _56320 ;  
					 ...
					 _LP0 = _LP0 + (   -29.4765637868736 * _TEMP); 
					  
 
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    2.77747428495119) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.30560687659238) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.58532588400211) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.39073495081853) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.13218051883563) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.85917413085378) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.68525095396904) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (     0.3939341369274) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (     0.1024928395042) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (    -0.1909043906677) * _TEMP * _1_9; 
					 _LP0 = _LP0 + (   -0.77668515578354) * _TEMP * _1_10; 
					...
					// ***  Effect: G_MDL_NO ; 
					 /*_TEMP = 1; 
					 _LP0 = _LP0 + (    0.51652844159509) * _TEMP * _2_0; 
					 _LP0 = _LP0 + (    0.00116056023742) * _TEMP * _2_1;  */
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("6141_C")) return  3; 
			 ...
			 else if (_Format.contains("6141_L")) return  7; 
			 else if (_Format.contains("6877_B")) return  7; 
			 else if (_Format.contains("6877_E")) return  5; 
			 else if (_Format.contains("7084_A")) return  3; 
			 ...
			 else if (_Format.contains("7084_H")) return  4; 
			 ...
			 else if (_Format.contains("7108_N")) return  6; 
			 else if (_Format.contains("7108_O")) return  5; 
			 else if (_Format.contains("7108_S")) return  6; 
			 else if (_Format.contains("7108_T")) return  9; 
			 else if (_Format.contains("7108_X")) return  7; 
			 else if (_Format.contains("7194_A")) return  6; 
			 ...
			 else if (_Format.contains("7323_E")) return  9; 
			 ...
			 else if (_Format.contains("7385_V")) return  1; 
			 ...
			 else if (_Format.contains("7670_P")) return  4; 
			 else if (_Format.contains("7670_R")) return  7; 
			 else if (_Format.contains("7670_S")) return  6; 
			 else if (_Format.contains("7670_T")) return  2; 
			 ...
			 else if (_Format.contains("7744_A")) return  8; 
			 ...
			 else if (_Format.contains("7900T4")) return  9; 
			 ...
			 else if (_Format.contains("8035_B")) return  2; 
			 else if (_Format.contains("8035_C")) return  11; 
			 else if (_Format.contains("8035_E")) return  11; 
			 ...
			 else if (_Format.contains("8035_Z")) return  3; 
			 ...
			 else if (_Format.contains("8038_S")) return  4; 
			 ...
			 else if (_Format.contains("8060_J")) return  4; 
			 ...
			 else if (_Format.contains("8060_Z")) return  3; 
			 ...
			 else if (_Format.contains("8066PC")) return  5; 
			 ...
			 else if (_Format.contains("8078_B")) return  9; 
			 else if (_Format.contains("8078_C")) return  3; 
			 else if (_Format.contains("8078_D")) return  6; 
			 else if (_Format.contains("8078_E")) return  8; 
			 else if (_Format.contains("8078_N")) return  9; 
			 else if (_Format.contains("8078_V")) return  11; 
			 ...
			 else if (_Format.contains("8101_Z")) return  5; 
			 ...
			 else if (_Format.contains("8107_E")) return  0; 
			 ...
			 else if (_Format.contains("8150F1")) return  6; 
			 ...
			 else if (_Format.contains("8150_I")) return  4; 
			 else if (_Format.contains("8150_K")) return  11; 
			 else if (_Format.contains("8150_L")) return  4; 
			 ...
			 else if (_Format.contains("8151_L")) return  7; 
			 else if (_Format.contains("8151_N")) return  11; 
			 else if (_Format.contains("8158_C")) return  3; 
			 ...
			 else if (_Format.contains("8227_H")) return  4; 
			 else if (_Format.contains("8227_I")) return  8; 
			 else if (_Format.contains("8245_A")) return  11; 
			 else if (_Format.contains("8245_B")) return  11; 
			 else if (_Format.contains("8245_C")) return  8; 
			 else if (_Format.contains("8245_F")) return  9; 
			 else if (_Format.contains("8245_L")) return  7; 
			 else if (_Format.contains("8245_N")) return  11; 
			 else if (_Format.contains("8245_W")) return  9; 
			 else if (_Format.contains("8254_A")) return  4; 
			 ...
			 else if (_Format.contains("8935_F")) return  5; 
			 ...
			 else if (_Format.contains("9650_A")) return  9; 
			 else if (_Format.contains("9650_B")) return  8; 
			 else if (_Format.contains("9650_C")) return  7; 
			 ...
			 else if (_Format.contains("9710_A")) return  3; 
			 ...
			 else if (_Format.contains("9734_A")) return  10; 
			 ...
			 else if (_Format.contains("9780_M")) return  5; 
