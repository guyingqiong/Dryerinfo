...
public class Calculate_14230_Dryer_Info {

	//take the input from outside
		public static double  Calculate_14230_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0124757097;
...
//				int G_MFG_BND_NMValue = 	G_MFG_BND_NM(G_MFG_BND_NM);	 
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0124757097;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// ***  Effect: _14240 ;  
					 ...
					 _LP0 = _LP0 + (    49.8820815775576 * _TEMP); 
					  
					 //***  Effect: _12120 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_12120")) ; 
					 _LP0 = _LP0 + (    -80.110940524484 * _TEMP); 
					  
					 
					  
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    1.94379958269126) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    1.32905034853209) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.08629642255691) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    0.78233468447798) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    0.51840673946938) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.39508489460087) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.16817279778297) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    -0.0569413387381) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (   -0.29951708663256) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (   -0.93468303297507) * _TEMP * _1_9; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("6141_B")) return  3; 
			 ...
			 else if (_Format.contains("6141_I")) return  1; 
			 ...
			 else if (_Format.contains("7744_D")) return  3; 
			 ...
			 else if (_Format.contains("7744_S")) return  10; 
			 ...
			 else if (_Format.contains("8038_Q")) return  1; 
			 else if (_Format.contains("8038_S")) return  4; 
			 else if (_Format.contains("8038_U")) return  1; 
			 else if (_Format.contains("8038_V")) return  0; 
			 ...
			 else if (_Format.contains("8129_V")) return  1; 
			 ...
			 else if (_Format.contains("8254_F")) return  1; 
			 ...
			 else if (_Format.contains("9759_A")) return  5; 
