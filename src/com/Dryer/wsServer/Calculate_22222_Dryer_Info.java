...
public class Calculate_22222_Dryer_Info {

	//take the input from outside
		public static double  Calculate_22222_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0119894837;
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0119894837;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// *** Compute Linear Predictor; 
					 ...
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    2.15935176438691) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (     1.4662045838265) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (     0.9742369786949) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    0.62054071073093) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    0.42971885832506) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.24223599014079) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.09321955407537) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (   -0.11896384863629) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (   -0.48883675590793) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (   -0.95913030448003) * _TEMP * _1_9; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("7084_C"))  return  4; 
			 ...
			 else if (_Format.contains("7385_W"))  return  1; 
			 ...
			 else if (_Format.contains("7670_W"))  return  1; 
			 ...
			 else if (_Format.contains("8066JA"))  return  3; 
			 ...
			 else if (_Format.contains("8107_F"))  return  2; 
			 ...
			 else if (_Format.contains("8150_I"))  return  5; 
			 ...
			 else if (_Format.contains("8175_D"))  return  2; 
			 ...
			 else if (_Format.contains("8180_A"))  return  7; 
