...
public class Calculate_66666_Dryer_Info {

	//take the input from outside
		public static double  Calculate_66666_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0042382485;
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0042382485;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// *** Compute Linear Predictor; 
					 ...
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (     2.8526323028397) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.49876832350659) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    2.17406457204278) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.84968113274048) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.54154201329912) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    1.17135414416144) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.65965650487825) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    0.24810495071377) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (   -0.18629235937135) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (   -0.81047530819901) * _TEMP * _1_9; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("6141_F"))  return     0; 
			 ...
			 else if (_Format.contains("7900N3"))  return     5; 
			 ...
			 else if (_Format.contains("8035_W"))  return     1; 
			 ...
			 else if (_Format.contains("8181_W"))  return     1; 
			 ...
			 else if (_Format.contains("8206_N"))  return     3; 
			 ...
			 else if (_Format.contains("8935_D"))  return     3; 
			 ...
			 else if (_Format.contains("9650_A"))  return     5; 
