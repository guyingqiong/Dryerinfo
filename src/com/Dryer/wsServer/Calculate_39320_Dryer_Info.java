...
public class Calculate_39320_Dryer_Info {

	//take the input from outside
		public static double  Calculate_39320_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0118648293;
...
//				int G_MFG_BND_NMValue = 	G_MFG_BND_NM(G_MFG_BND_NM);	 
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0118648293;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// *** Compute Linear Predictor; 
					 ...
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    3.03041042688162) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.08780238668849) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.76898939564159) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.54004670586593) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.23638814757055) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    1.01817763489364) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.72012776361606) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    0.42209436125665) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (    0.06811469685569) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (   -0.29605389343094) * _TEMP * _1_9; 
					 _LP0 = _LP0 + (   -0.80119101123749) * _TEMP * _1_10; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("7084_L"))  return     5; 
			 ...
			 else if (_Format.contains("7108_X"))  return     5; 
			 ...
			 else if (_Format.contains("7194_L"))  return     2; 
			 ...
			 else if (_Format.contains("7908I5"))  return     1; 
			 ...
			 else if (_Format.contains("8035_C"))  return     1; 
			 ...
			 else if (_Format.contains("8035_P"))  return     1; 
			 ...
			 else if (_Format.contains("8129_V"))  return     10; 
			 else if (_Format.contains("8129_W"))  return     10; 
			 else if (_Format.contains("8129_X"))  return     1; 
			 ...
			 else if (_Format.contains("8147_G"))  return     7; 
			 ...
			 else if (_Format.contains("8150_E"))  return     9; 
			 ...
			 else if (_Format.contains("8180_J"))  return     1; 
			 else if (_Format.contains("8180_K"))  return     4; 
			 ...
			 else if (_Format.contains("8206T"))  return     7; 
			 ...
			 else if (_Format.contains("8206_G"))  return     10; 
			 ...
			 else if (_Format.contains("8206_N"))  return     1; 
			 ...
			 else if (_Format.contains("8227_E"))  return     4; 
			 ...
			 else if (_Format.contains("8254_H"))  return     5; 
			 ...
			 else if (_Format.contains("8368_J"))  return     2; 
			 ...
			 else if (_Format.contains("8935_F"))  return     3; 
