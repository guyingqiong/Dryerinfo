...
public class Calculate_55555_Dryer_Info {

	//take the input from outside
		public static double  Calculate_55555_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0048501881;
...
//				int G_MFG_BND_NMValue = 	G_MFG_BND_NM(G_MFG_BND_NM);	 
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0048501881;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// *** Compute Linear Predictor; 
					 ...
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    3.56604093103773) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.87289375047793) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    2.07979840189757) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.67674367183313) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.27292816867903) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (     0.9820015437278) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.69528533763656) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    0.33433496409054) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (   -0.01560569831482) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (   -0.37713450246718) * _TEMP * _1_9; 
					 _LP0 = _LP0 + (   -1.04787874507073) * _TEMP * _1_10; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("6141_B"))  return     10; 
			 ...
			 else if (_Format.contains("7084_G"))  return     11; 
			 ...
			 else if (_Format.contains("7108_N"))  return     11; 
			 else if (_Format.contains("7108_O"))  return     5; 
			 else if (_Format.contains("7108_S"))  return     10; 
			 ...
			 else if (_Format.contains("7194_E"))  return     5; 
			 ...
			 else if (_Format.contains("7194_N"))  return     11; 
			 ...
			 else if (_Format.contains("7323_E"))  return     11; 
			 ...
			 else if (_Format.contains("7385_L"))  return     11; 
			 ...
			 else if (_Format.contains("7385_S"))  return     11; 
			 ...
			 else if (_Format.contains("7670_S"))  return     11; 
			 ...
			 else if (_Format.contains("7900G4"))  return     11; 
			 ...
			 else if (_Format.contains("7900T4"))  return     5; 
			 ...
			 else if (_Format.contains("7983_J"))  return     7; 
			 ...
			 else if (_Format.contains("7983_O"))  return     5; 
			 else if (_Format.contains("7983_P"))  return     4; 
			 else if (_Format.contains("8035_A"))  return     11; 
			 ...
			 else if (_Format.contains("8035_J"))  return     11; 
			 else if (_Format.contains("8035_M"))  return     5; 
			 else if (_Format.contains("8035_O"))  return     11; 
			 ...
			 else if (_Format.contains("8035_T"))  return     5; 
			 else if (_Format.contains("8035_U"))  return     11; 
			 else if (_Format.contains("8035_V"))  return     4; 
			 else if (_Format.contains("8035_W"))  return     11; 
			 ...
			 else if (_Format.contains("8038_Q"))  return     11; 
			 ...
			 else if (_Format.contains("8060_A"))  return     11; 
			 ...
			 else if (_Format.contains("8060_E"))  return     2; 
			 else if (_Format.contains("8060_F"))  return     5; 
			 else if (_Format.contains("8060_G"))  return     11; 
			 else if (_Format.contains("8060_H"))  return     11; 
			 ...
			 else if (_Format.contains("8060_Q"))  return     2; 
			 ...
			 else if (_Format.contains("8066AL"))  return     2; 
			 else if (_Format.contains("8066BR"))  return     11; 
			 else if (_Format.contains("8066DO"))  return     6; 
			 else if (_Format.contains("8066GP"))  return     11; 
			 ...
			 else if (_Format.contains("8066PC"))  return     11; 
			 ...
			 else if (_Format.contains("8078_C"))  return     4; 
			 ...
			 else if (_Format.contains("8078_V"))  return     4; 
			 else if (_Format.contains("8101_C"))  return     11; 
			 ...
			 else if (_Format.contains("8107_A"))  return     11; 
			 else if (_Format.contains("8107_C"))  return     11; 
			 else if (_Format.contains("8107_D"))  return     11; 
			 ...
			 else if (_Format.contains("8129_A"))  return     11; 
			 ...
			 else if (_Format.contains("8129_O"))  return     6; 
			 ...
			 else if (_Format.contains("8129_U"))  return     4; 
			 else if (_Format.contains("8129_V"))  return     11; 
			 ...
			 else if (_Format.contains("8147_C"))  return     11; 
			 else if (_Format.contains("8147_D"))  return     11; 
			 else if (_Format.contains("8147_E"))  return     11; 
			 else if (_Format.contains("8147_F"))  return     7; 
			 else if (_Format.contains("8147_G"))  return     11; 
			 else if (_Format.contains("8147_L"))  return     11; 
			 else if (_Format.contains("8147_O"))  return     4; 
			 ...
			 else if (_Format.contains("8150_L"))  return     6; 
			 else if (_Format.contains("8150_O"))  return     11; 
			 else if (_Format.contains("8150_P"))  return     8; 
			 ...
			 else if (_Format.contains("8151_L"))  return     11; 
			 else if (_Format.contains("8151_N"))  return     6; 
			 else if (_Format.contains("8158_C"))  return     11; 
			 else if (_Format.contains("8158_D"))  return     11; 
			 ...
			 else if (_Format.contains("8162_E"))  return     4; 
			 ...
			 else if (_Format.contains("8175_D"))  return     1; 
			 ...
			 else if (_Format.contains("8180_D"))  return     11; 
			 ...
			 else if (_Format.contains("8180_H"))  return     11; 
			 ...
			 else if (_Format.contains("8181_W"))  return     2; 
			 else if (_Format.contains("8206F"))  return     11; 
			 else if (_Format.contains("8206MC"))  return     11; 
			 else if (_Format.contains("8206MG"))  return     11; 
			 else if (_Format.contains("8206T"))  return     5; 
			 ...
			 else if (_Format.contains("8206_K"))  return     3; 
			 ...
			 else if (_Format.contains("8206_P"))  return     11; 
			 ...
			 else if (_Format.contains("8245_W"))  return     7; 
			 else if (_Format.contains("8254_A"))  return     8; 
			 ...
			 else if (_Format.contains("8320_I"))  return     11; 
			 ...
			 else if (_Format.contains("8368_X"))  return     10; 
			 ...
			 else if (_Format.contains("9265_A"))  return     3; 
			 ...
			 else if (_Format.contains("9702_A"))  return     7; 
			 ...
			 else if (_Format.contains("9759_N"))  return     10; 
			 else if (_Format.contains("9780_A"))  return     9; 
			 else if (_Format.contains("9780_M"))  return     7; 
			 else if (_Format.contains("9784_A"))  return     6; 
			 else if (_Format.contains("9787_A"))  return     10; 
