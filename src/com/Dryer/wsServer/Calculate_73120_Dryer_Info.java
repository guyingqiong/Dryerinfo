...
public class Calculate_73120_Dryer_Info {

	//take the input from outside
		public static double  Calculate_73120_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0216158711;
...
//				int G_MFG_BND_NMValue = 	G_MFG_BND_NM(G_MFG_BND_NM);	 
				...
				//*** Check _13150 for missing values ; 
					...
					//	 *** Check _14125 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_14125")) -0.0 <=0.000000000000001  )  
	      				    _DM_BAD = 1; 
						  
					//	 *** Check _39140 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_39140")) -0.0 <=0.000000000000001  )  
	      				    _DM_BAD = 1; 
					...
					//	 *** Check _56110 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_56110")) -0.0 <=0.000000000000001  )  
	      				    _DM_BAD = 1; 
				...
				//			 *** Check _95920 for missing values ; 
						 if (ProResults.Probility.get(ProResults.IDs.indexOf("_95920")) -0.0 <=0.000000000000001  )  
	      				    _DM_BAD = 1; 
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0216158711;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// ***  Effect: _13150 ;  
					 ...
					 _LP0 = _LP0 + (   -35.6200668809141 * _TEMP); 
					  
					 //***  Effect: _14120 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_14120")) ; 
					 _LP0 = _LP0 + (    13.9333081097508 * _TEMP); 
					  
					// ***  Effect: _14125 ;  
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_14125")) ; 
					 _LP0 = _LP0 + (   -18.3279877280141 * _TEMP); 
					  
					 //***  Effect: _39140 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_39140")) ; 
					 _LP0 = _LP0 + (    3.73493270796602 * _TEMP);
					 
					// ***  Effect: _39320 ;  
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_39320")) ; 
					 _LP0 = _LP0 + (    21.6945608159334 * _TEMP); 
					  
					 //***  Effect: _56110 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_56110")) ; 
					 _LP0 = _LP0 + (   -28.5240964070372 * _TEMP); 
					 
					// ***  Effect: _71120 ;  
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_71120")) ; 
					 _LP0 = _LP0 + (   -15.7954247764369 * _TEMP); 
					  
					 //***  Effect: _73120 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_73120")) ; 
					 _LP0 = _LP0 + (    88.2347675686185 * _TEMP); 
					  
					 //***  Effect: _73330 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_73330")) ; 
					 _LP0 = _LP0 + (   -34.0094381271497 * _TEMP); 
					 
					// ***  Effect: _95920 ;  
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_95920")) ; 
					 _LP0 = _LP0 + (   -43.4156366959182 * _TEMP); 
					  
					 //***  Effect: _95930 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_95930")) ; 
					 _LP0 = _LP0 + (    15.7854371276043 * _TEMP); 
					 
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    3.08353301649727) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.44079198538358) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.88130065229088) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.50142264285456) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.18330341855134) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (     0.7923281355336) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.64255441424235) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (     0.4800861150408) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (    0.21512220536617) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (    0.14198788511333) * _TEMP * _1_9; 
					 _LP0 = _LP0 + (   -0.32084294663301) * _TEMP * _1_10; 
					 _LP0 = _LP0 + (   -1.28922293253568) * _TEMP * _1_11; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			else if (_Format.contains("4766_A"))  return   4; 
			 ...
			 else if (_Format.contains("4766_I"))  return   9; 
			 ...
			 else if (_Format.contains("6141_C"))  return   12; 
			 else if (_Format.contains("6141_E"))  return   8; 
			 ...
			 else if (_Format.contains("7108_X"))  return   7; 
			 ...
			 else if (_Format.contains("7194_L"))  return   5; 
			 else if (_Format.contains("7194_M"))  return   7; 
			 else if (_Format.contains("7194_N"))  return   7; 
			 else if (_Format.contains("7194_O"))  return   10; 
			 else if (_Format.contains("7194_P"))  return   4; 
			 else if (_Format.contains("7194_U"))  return   5; 
			 else if (_Format.contains("7289_A"))  return   6; 
			 else if (_Format.contains("7323_C"))  return   6; 
			 else if (_Format.contains("7323_E"))  return   2; 
			 else if (_Format.contains("7385_C"))  return   1; 
			 ...
			 else if (_Format.contains("7385_L"))  return   8; 
			 else if (_Format.contains("7385_M"))  return   12; 
			 else if (_Format.contains("7385_N"))  return   11; 
			 else if (_Format.contains("7385_O"))  return   12; 
			 ...
			 else if (_Format.contains("7385_S"))  return   3; 
			 else if (_Format.contains("7385_T"))  return   2; 
			 else if (_Format.contains("7385_V"))  return   12; 
			 else if (_Format.contains("7385_W"))  return   2; 
			 else if (_Format.contains("7385_Z"))  return   2; 
			 else if (_Format.contains("7435DD"))  return   6; 
			 else if (_Format.contains("7435EE"))  return   8; 
			 else if (_Format.contains("7435_A"))  return   6; 
			 else if (_Format.contains("7435_B"))  return   5; 
			 else if (_Format.contains("7435_C"))  return   7; 
			 ...
			 else if (_Format.contains("7670_K"))  return   8; 
			 ...
			 else if (_Format.contains("7744_A"))  return   10; 
			 else if (_Format.contains("7744_B"))  return   10; 
			 ...
			 else if (_Format.contains("7900U3"))  return   8; 
			 ...
			 else if (_Format.contains("7908M1"))  return   7; 
			 else if (_Format.contains("7908M2"))  return   12; 
			 else if (_Format.contains("7983_J"))  return   8; 
			 else if (_Format.contains("7983_K"))  return   5; 
			 else if (_Format.contains("7983_L"))  return   7; 
			 ...
			 else if (_Format.contains("8035_H"))  return   8; 
			 ...
			 else if (_Format.contains("8035_P"))  return   12; 
			 else if (_Format.contains("8035_Q"))  return   6; 
			 else if (_Format.contains("8035_S"))  return   9; 
			 else if (_Format.contains("8035_T"))  return   10; 
			 else if (_Format.contains("8035_U"))  return   4; 
			 else if (_Format.contains("8035_V"))  return   5; 
			 else if (_Format.contains("8035_W"))  return   10; 
			 else if (_Format.contains("8035_Y"))  return   7; 
			 else if (_Format.contains("8035_Z"))  return   12; 
			 ...
			 else if (_Format.contains("8038_S"))  return   11; 
			 ...
			 else if (_Format.contains("8060_B"))  return   6; 
			 ...
			 else if (_Format.contains("8060_F"))  return   9; 
			 else if (_Format.contains("8060_G"))  return   10; 
			 else if (_Format.contains("8060_H"))  return   7; 
			 else if (_Format.contains("8060_I"))  return   5; 
			 else if (_Format.contains("8060_J"))  return   10; 
			 else if (_Format.contains("8060_L"))  return   7; 
			 else if (_Format.contains("8060_M"))  return   12; 
			 else if (_Format.contains("8060_N"))  return   2; 
			 else if (_Format.contains("8060_O"))  return   4; 
			 else if (_Format.contains("8060_P"))  return   0; 
			 else if (_Format.contains("8060_Q"))  return   3; 
			 else if (_Format.contains("8060_S"))  return   12; 
			 else if (_Format.contains("8060_T"))  return   9; 
			 ...
			 else if (_Format.contains("8060_Z"))  return   12; 
			 else if (_Format.contains("8066AL"))  return   10; 
			 else if (_Format.contains("8066BR"))  return   3; 
			 else if (_Format.contains("8066DO"))  return   8; 
			 ...
			 else if (_Format.contains("8066LA"))  return   10; 
			 else if (_Format.contains("8066MB"))  return   12; 
			 else if (_Format.contains("8066ME"))  return   7; 
			 else if (_Format.contains("8066MG"))  return   5; 
			 else if (_Format.contains("8066NO"))  return   3; 
			 else if (_Format.contains("8066PC"))  return   6; 
			 else if (_Format.contains("8066PN"))  return   9; 
			 else if (_Format.contains("8066SL"))  return   12; 
			 else if (_Format.contains("8066SM"))  return   6; 
			 else if (_Format.contains("8066ZZ"))  return   12; 
			 ...
			 else if (_Format.contains("8078_D"))  return   7; 
			 else if (_Format.contains("8078_E"))  return   4; 
			 ...
			 else if (_Format.contains("8101_X"))  return   2; 
			 ...
			 else if (_Format.contains("8107_E"))  return   12; 
			 else if (_Format.contains("8107_F"))  return   9; 
			 else if (_Format.contains("8107_L"))  return   5; 
			 else if (_Format.contains("8107_S"))  return   10; 
			 ...
			 else if (_Format.contains("8129_E"))  return   7; 
			 ...
			 else if (_Format.contains("8129_P"))  return   7; 
			 ...
			 else if (_Format.contains("8129_X"))  return   9; 
			 ...
			 else if (_Format.contains("8147_L"))  return   6; 
			 else if (_Format.contains("8147_O"))  return   9; 
			 else if (_Format.contains("8150F1"))  return   12; 
			 else if (_Format.contains("8150_A"))  return   6; 
			 else if (_Format.contains("8150_B"))  return   9; 
			 else if (_Format.contains("8150_C"))  return   6; 
			 else if (_Format.contains("8150_E"))  return   4; 
			 else if (_Format.contains("8150_G"))  return   5; 
			 else if (_Format.contains("8150_I"))  return   7; 
			 else if (_Format.contains("8150_K"))  return   1; 
			 ...
			 else if (_Format.contains("8150_Q"))  return   7; 
			 ...
			 else if (_Format.contains("8151_G"))  return   12; 
			 else if (_Format.contains("8151_K"))  return   3; 
			 else if (_Format.contains("8151_L"))  return   6; 
			 else if (_Format.contains("8151_N"))  return   5; 
			 else if (_Format.contains("8158_C"))  return   5; 
			 else if (_Format.contains("8158_D"))  return   8; 
			 ...
			 else if (_Format.contains("8158_O"))  return   10; 
			 else if (_Format.contains("8162_A"))  return   5; 
			 else if (_Format.contains("8162_B"))  return   7; 
			 else if (_Format.contains("8162_E"))  return   9; 
			 else if (_Format.contains("8162_F"))  return   7; 
			 else if (_Format.contains("8162_H"))  return   10; 
			 else if (_Format.contains("8162_I"))  return   7; 
			 else if (_Format.contains("8162_K"))  return   4; 
			 else if (_Format.contains("8162_L"))  return   12; 
			 else if (_Format.contains("8162_M"))  return   6; 
			 else if (_Format.contains("8162_N"))  return   8; 
			 else if (_Format.contains("8162_Q"))  return   8; 
			 else if (_Format.contains("8162_R"))  return   4; 
			 ...
			 else if (_Format.contains("8175_E"))  return   8; 
			 else if (_Format.contains("8175_F"))  return   5; 
			 ...
			 else if (_Format.contains("8180_B"))  return   6; 
			 else if (_Format.contains("8180_C"))  return   7; 
			 ...
			 else if (_Format.contains("8206MG"))  return   12; 
			 ...
			 else if (_Format.contains("8206_H"))  return   9; 
			 ...
			 else if (_Format.contains("8206_L"))  return   10; 
			 else if (_Format.contains("8206_M"))  return   4; 
			 else if (_Format.contains("8206_N"))  return   4; 
			 else if (_Format.contains("8206_O"))  return   7; 
			 else if (_Format.contains("8206_P"))  return   7; 
			 ...
			 else if (_Format.contains("8227_C"))  return   1; 
			 ...
			 else if (_Format.contains("8245_C"))  return   7; 
			 else if (_Format.contains("8245_F"))  return   7; 
			 else if (_Format.contains("8245_L"))  return   9; 
			 else if (_Format.contains("8245_N"))  return   7; 
			 else if (_Format.contains("8245_W"))  return   11; 
			 else if (_Format.contains("8254_A"))  return   12; 
			 else if (_Format.contains("8254_B"))  return   10; 
			 else if (_Format.contains("8254_C"))  return   8; 
			 else if (_Format.contains("8254_D"))  return   5; 
			 ...
			 else if (_Format.contains("8254_K"))  return   12; 
			 ...
			 else if (_Format.contains("8254_O"))  return   11; 
			 ...
			 else if (_Format.contains("8320_I"))  return   10; 
			 else if (_Format.contains("8320_L"))  return   9; 
			 else if (_Format.contains("8320_M"))  return   10; 
			 else if (_Format.contains("8320_P"))  return   8; 
			 else if (_Format.contains("8320_X"))  return   5; 
			 else if (_Format.contains("8368_A"))  return   7; 
			 else if (_Format.contains("8368_D"))  return   9; 
			 ...
			 else if (_Format.contains("8368_R"))  return   7; 
			 ...
			 else if (_Format.contains("8935_C"))  return   11; 
			 else if (_Format.contains("8935_D"))  return   11; 
			 else if (_Format.contains("8935_F"))  return   7; 
			 else if (_Format.contains("8935_M"))  return   10; 
			 else if (_Format.contains("8935_P"))  return   8; 
			 else if (_Format.contains("8935_S"))  return   9; 
			 else if (_Format.contains("8935_T"))  return   12; 
			 else if (_Format.contains("9197_A"))  return   10; 
			 else if (_Format.contains("9263_A"))  return   6; 
			 else if (_Format.contains("9265_A"))  return   6; 
			 ...
			 else if (_Format.contains("9664_A"))  return   7; 
			 else if (_Format.contains("9665_A"))  return   7; 
			 else if (_Format.contains("9700_A"))  return   9; 
			 else if (_Format.contains("9700_D"))  return   5; 
			 else if (_Format.contains("9701_A"))  return   5; 
			 else if (_Format.contains("9701_B"))  return   7; 
			 else if (_Format.contains("9701_C"))  return   7; 
			 else if (_Format.contains("9702_A"))  return   5; 
			 else if (_Format.contains("9702_S"))  return   12; 
			 else if (_Format.contains("9702_V"))  return   9; 
			 else if (_Format.contains("9709_A"))  return   7; 
			 ...
			 else if (_Format.contains("9734_A"))  return   8; 
			 else if (_Format.contains("9759_A"))  return   8; 
			 else if (_Format.contains("9759_B"))  return   6; 
