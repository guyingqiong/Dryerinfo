...
public class Calculate_77777_Dryer_Info {

	//take the input from outside
		public static double  Calculate_77777_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
