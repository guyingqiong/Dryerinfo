...
public class Calculate_93950_Dryer_Info {

	//take the input from outside
		public static double  Calculate_93950_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.0060627351;
...
//				int G_MFG_BND_NMValue = 	G_MFG_BND_NM(G_MFG_BND_NM);	 
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.0060627351;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// *** Compute Linear Predictor; 
					 ...
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    2.43050489328204) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.36787516960659) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.78341801945443) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.47301069248354) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.14100238537135) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.93074911440023) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.68804789903464) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    0.37189059667925) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (   -0.06329017306543) * _TEMP * _1_8; 
					  
					  
					// ***  Effect: G_ITM_AGE2 ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (     1.0604539734512) * _TEMP * _2_0; 
					 _LP0 = _LP0 + (    0.47756779678148) * _TEMP * _2_1; 
					 _LP0 = _LP0 + (    0.10760757886999) * _TEMP * _2_2; 
					 _LP0 = _LP0 + (   -0.48223421936294) * _TEMP * _2_3; 
					 
					
					  
					 
					 _TEMP =    -5.20523279518115 + _LP0; 
					 if (_TEMP < 0) {
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("4766_C"))  return    9; 
			 else if (_Format.contains("4766_E"))  return    6; 
			 else if (_Format.contains("4766_G"))  return    3; 
			 else if (_Format.contains("4766_I"))  return    9; 
			 else if (_Format.contains("4766_J"))  return    0; 
			 else if (_Format.contains("4766_K"))  return    9; 
			 else if (_Format.contains("4766_L"))  return    9; 
			 else if (_Format.contains("4766_S"))  return    9; 
			 else if (_Format.contains("4766_T"))  return    9; 
			 else if (_Format.contains("6141_A"))  return    9; 
			 ...
			 else if (_Format.contains("7084_E"))  return    9; 
			 ...
			 else if (_Format.contains("7194_L"))  return    9; 
			 ...
			 else if (_Format.contains("7385_C"))  return    9; 
			 else if (_Format.contains("7385_E"))  return    9; 
			 else if (_Format.contains("7385_F"))  return    8; 
			 else if (_Format.contains("7385_G"))  return    9; 
			 else if (_Format.contains("7385_H"))  return    9; 
			 else if (_Format.contains("7385_I"))  return    1; 
			 else if (_Format.contains("7385_J"))  return    9; 
			 else if (_Format.contains("7385_L"))  return    9; 
			 else if (_Format.contains("7385_M"))  return    9; 
			 else if (_Format.contains("7385_N"))  return    7; 
			 else if (_Format.contains("7385_O"))  return    9; 
			 else if (_Format.contains("7385_P"))  return    9; 
			 else if (_Format.contains("7385_Q"))  return    9; 
			 else if (_Format.contains("7385_R"))  return    9; 
			 else if (_Format.contains("7385_S"))  return    9; 
			 else if (_Format.contains("7385_T"))  return    9; 
			 else if (_Format.contains("7385_V"))  return    9; 
			 else if (_Format.contains("7385_W"))  return    9; 
			 else if (_Format.contains("7385_Z"))  return    9; 
			 ...
			 else if (_Format.contains("7435_C"))  return    3; 
			 ...
			 else if (_Format.contains("7670_W"))  return    9; 
			 else if (_Format.contains("7670_X"))  return    9; 
			 ...
			 else if (_Format.contains("8035_Y"))  return    9; 
			 ...
			 else if (_Format.contains("8066SL"))  return    9; 
			 ...
			 else if (_Format.contains("8101_X"))  return    9; 
			 ...
			 else if (_Format.contains("8107_E"))  return    9; 
			 ...
			 else if (_Format.contains("8129_C"))  return    9; 
			 else if (_Format.contains("8129_E"))  return    9; 
			 else if (_Format.contains("8129_F"))  return    7; 
			 else if (_Format.contains("8129_G"))  return    4; 
			 else if (_Format.contains("8129_O"))  return    5; 
			 else if (_Format.contains("8129_P"))  return    9; 
			 else if (_Format.contains("8129_Q"))  return    5; 
			 ...
			 else if (_Format.contains("8129_W"))  return    9; 
			 ...
			 else if (_Format.contains("8150_T"))  return    9; 
			 else if (_Format.contains("8150_W"))  return    9; 
			 else if (_Format.contains("8151_B"))  return    9; 
			 else if (_Format.contains("8151_C"))  return    9; 
			 else if (_Format.contains("8151_E"))  return    8; 
			 else if (_Format.contains("8151_G"))  return    9; 
			 else if (_Format.contains("8151_K"))  return    2; 
			 ...
			 else if (_Format.contains("8162_M"))  return    9; 
			 ...
			 else if (_Format.contains("8175_H"))  return    9; 
			 else if (_Format.contains("8175_I"))  return    9; 
			 else if (_Format.contains("8180_A"))  return    4; 
			 else if (_Format.contains("8180_B"))  return    4; 
			 else if (_Format.contains("8180_C"))  return    9; 
			 else if (_Format.contains("8180_D"))  return    9; 
			 else if (_Format.contains("8180_E"))  return    9; 
			 ...
			 else if (_Format.contains("8206_I"))  return    9; 
			 else if (_Format.contains("8206_J"))  return    9; 
			 else if (_Format.contains("8206_K"))  return    4; 
			 else if (_Format.contains("8206_L"))  return    7; 
			 else if (_Format.contains("8206_M"))  return    9; 
			 else if (_Format.contains("8206_N"))  return    9; 
			 ...
			 else if (_Format.contains("8227_F"))  return    9; 
			 else if (_Format.contains("8227_G"))  return    3; 
			 else if (_Format.contains("8227_H"))  return    9; 
			 else if (_Format.contains("8227_I"))  return    3; 
			 else if (_Format.contains("8245_A"))  return    3; 
			 else if (_Format.contains("8245_B"))  return    2; 
			 ...
			 else if (_Format.contains("8254_I"))  return    9; 
			 else if (_Format.contains("8254_J"))  return    9; 
			 else if (_Format.contains("8254_K"))  return    9; 
			 ...
			 else if (_Format.contains("8320_M"))  return    5; 
			 else if (_Format.contains("8320_P"))  return    7; 
			 else if (_Format.contains("8320_X"))  return    9; 
			 ...
			 else if (_Format.contains("8935_C"))  return    4; 
			 else if (_Format.contains("8935_D"))  return    9; 
			 else if (_Format.contains("8935_F"))  return    9; 
			 else if (_Format.contains("8935_M"))  return    7; 
			 else if (_Format.contains("8935_P"))  return    3; 
			 else if (_Format.contains("8935_S"))  return    9; 
			 else if (_Format.contains("8935_T"))  return    9; 
			 else if (_Format.contains("9197_A"))  return    4; 
			 else if (_Format.contains("9263_A"))  return    2; 
			 else if (_Format.contains("9265_A"))  return    9; 
			 else if (_Format.contains("9266_A"))  return    9; 
			 ...
			 else if (_Format.contains("9702_A"))  return    4; 
			 ...
			 else if (_Format.contains("9720_A"))  return    3; 
