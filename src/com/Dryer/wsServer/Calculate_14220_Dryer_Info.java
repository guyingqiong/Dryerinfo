...
public class Calculate_14220_Dryer_Info {

	//take the input from outside
		public static double  Calculate_14220_Dryer(String G_IRU,String G_ITM_AGE2,String G_MDL_NO,String G_MFG_BND_NM,String Word_Bank){
			try {
				
				MyCustomClass ProResults = ReadHistoryData.ReadData(Word_Bank);
				//this value needs to be modified ..
				if(ProResults ==null) return  0.01606908118398;
...
//				int G_MFG_BND_NMValue = 	G_MFG_BND_NM(G_MFG_BND_NM);	 
				...
				/*		
				 //*** Generate dummy variables for G_MFG_BND_NM ; 
					...
					if (G_MFG_BND_NMValue == 0 ) {
					 ...
					 if (_DM_BAD > 0 ) return  0.01606908118398;
					    //_P0 = 0.1045190843; 
					    //_P1 = 0.8954809157; 
					...
					// ***  Effect: _14240 ;  
					 ...
					 _LP0 = _LP0 + (    38.3823761230338 * _TEMP); 
					  
					 //***  Effect: _12120 ; 
					 _TEMP = ProResults.Probility.get(ProResults.IDs.indexOf("_12120")) ; 
					 _LP0 = _LP0 + (    -59.778383476032 * _TEMP); 
					  
					 
					 //***  Effect: G_IRU ; 
					 _TEMP = 1; 
					 _LP0 = _LP0 + (    2.44977509871497) * _TEMP * _1_0; 
					 _LP0 = _LP0 + (    2.04255743326907) * _TEMP * _1_1; 
					 _LP0 = _LP0 + (    1.61962509891416) * _TEMP * _1_2; 
					 _LP0 = _LP0 + (    1.39563458846743) * _TEMP * _1_3; 
					 _LP0 = _LP0 + (    1.14076083861025) * _TEMP * _1_4; 
					 _LP0 = _LP0 + (    0.87081665409972) * _TEMP * _1_5; 
					 _LP0 = _LP0 + (    0.62371418106788) * _TEMP * _1_6; 
					 _LP0 = _LP0 + (    0.40633454033297) * _TEMP * _1_7; 
					 _LP0 = _LP0 + (    0.20409384734137) * _TEMP * _1_8; 
					 _LP0 = _LP0 + (   -0.12178780122029) * _TEMP * _1_9; 
					 _LP0 = _LP0 + (   -0.60781798346077) * _TEMP * _1_10; 
		...
		public static int G_IRU(String _Format){
			...
			//else if (_Format.contains("4766_A"))  return  6; 
			 ...
			 else if (_Format.contains("7084_B")) return  7; 
			 ...
			 else if (_Format.contains("7385_E")) return  4; 
			 ...
			 else if (_Format.contains("7385_J")) return  7; 
			 else if (_Format.contains("7385_L")) return  9; 
			 else if (_Format.contains("7385_M")) return  1; 
			 ...
			 else if (_Format.contains("7670_V")) return  3; 
			 ...
			 else if (_Format.contains("8035_Z")) return  7; 
			 else if (_Format.contains("8038_I")) return  5; 
			 ...
			 else if (_Format.contains("8038_O")) return  3; 
			 ...
			 else if (_Format.contains("8066HO")) return  7; 
			 ...
			 else if (_Format.contains("8066SL")) return  4; 
			 ...
			 else if (_Format.contains("8107_F")) return  3; 
			 ...
			 else if (_Format.contains("8129_B")) return  3; 
			 ...
			 else if (_Format.contains("8129_S")) return  5; 
			 ...
			 else if (_Format.contains("8150_G")) return  3; 
			 ...
			 else if (_Format.contains("8158_C")) return  4; 
			 ...
			 else if (_Format.contains("8162_H")) return  11; 
			 else if (_Format.contains("8162_I")) return  5; 
			 else if (_Format.contains("8162_K")) return  1; 
			 else if (_Format.contains("8162_L")) return  3; 
			 ...
			 else if (_Format.contains("8180_E")) return  2; 
			 ...
			 else if (_Format.contains("8180_K")) return  3; 
			 else if (_Format.contains("8180_L")) return  5; 
			 ...
			 else if (_Format.contains("8206MG")) return  2; 
			 ...
			 else if (_Format.contains("8206_M")) return  7; 
			 ...
			 else if (_Format.contains("8227_F")) return  1; 
			 ...
			 else if (_Format.contains("8254_P")) return  5; 
			 ...
			 else if (_Format.contains("8368_J")) return  3; 
			 else if (_Format.contains("8368_O")) return  7; 
			 else if (_Format.contains("8368_P")) return  6; 
			 else if (_Format.contains("8368_R")) return  5; 
